...
#### Parameters
  ...
  - paymentCards  
    Type: [System.Collections.ObjectModel.Collection](https://technet.microsoft.com/en-us/library/ms132397\(v=ax.60\))\<[Payment](payment-class-microsoft-dynamics-retail-sharepoint-web-services-viewmodel.md)\>  

---
title: EmployeeDataManager.ExecuteStoredProcedureScalar Method  (Microsoft.Dynamics.Commerce.Runtime.Data)
TOCTitle: ExecuteStoredProcedureScalar Method
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.Data.EmployeeDataManager.ExecuteStoredProcedureScalar
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.employeedatamanager.executestoredprocedurescalar(v=AX.60)
ms:contentKeyID: 62207775
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- ExecuteStoredProcedureScalar
- EmployeeDataManager.ExecuteStoredProcedureScalar
- Microsoft.Dynamics.Commerce.Runtime.Data.EmployeeDataManager.ExecuteStoredProcedureScalar
dev_langs:
- CSharp
- C++
- VB

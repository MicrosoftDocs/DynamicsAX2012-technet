...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.employeedatamanager.getemployeebreakcategoriesbyactivity(v=AX.60)

---
title: IFiscalPrinterV1.PreVoidTransaction Method  (Microsoft.Dynamics.Retail.Pos.Contracts.Services)
TOCTitle: PreVoidTransaction Method
ms:assetid: M:Microsoft.Dynamics.Retail.Pos.Contracts.Services.IFiscalPrinterV1.PreVoidTransaction(Microsoft.Dynamics.Retail.Pos.Contracts.Triggers.IPreTriggerResult,Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity.IPosTransaction)
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.services.ifiscalprinterv1.prevoidtransaction(v=AX.60)
ms:contentKeyID: 62204391
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Pos.Contracts.Services.IFiscalPrinterV1.PreVoidTransaction
dev_langs:
- CSharp
- C++
- VB

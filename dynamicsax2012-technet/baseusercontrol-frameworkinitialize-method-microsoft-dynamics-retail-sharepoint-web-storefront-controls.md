...
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.BaseUserControl.FrameworkInitialize
dev_langs:
- CSharp
- C++
- VB
...
``` c++
protected:
virtual void FrameworkInitialize() override
```

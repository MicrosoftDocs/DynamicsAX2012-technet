...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.client.shippingmanager.createorupdateshipmentpublishingstatus(v=AX.60)

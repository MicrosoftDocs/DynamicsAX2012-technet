...
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Common.CommonConstants.ItemNumberSearchPropertyName
dev_langs:
- CSharp
- C++
- VB
...
Represents the name of the search property that contains the item's catalog number.

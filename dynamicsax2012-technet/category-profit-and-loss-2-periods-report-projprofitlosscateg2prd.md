...
# Category profit and loss (2 periods) report (ProjProfitLossCateg2Prd) [AX 2012]
...
<p><strong>From date</strong> / <strong>To date</strong></p></td>
<td><p>Specify a starting date and an ending date to include project transactions that are posted to the ledger in period 2.</p></td>
</tr>
<tr class="odd">
...
<td><p>Select whether to exclude all rows in the report where the amounts are equal to zero.</p></td>
</tr>
<tr class="even">
...
<td><p>Click <strong>Select</strong>. In the <strong>Category profit and loss (2 periods)</strong> form, select a category to include on the report. To add more than one category, click <strong>Add</strong>.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS reports\Reports\ProjProfitLossCateg2Prd</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Project management and accounting</strong> &gt; <strong>Reports</strong> &gt; <strong>Project statements</strong> &gt; <strong>Profit and loss</strong> &gt; <strong>Profit and loss (2 periods)</strong> &gt; <strong>Category profit and loss (2 periods)</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - ProjListProjProfitLossCateg2PrdDP.processReport
...
> [!NOTE]
> <P>To determine where the data in the temp table comes from, view the cross-references for the ProjListProjProfitLossCateg2PrdDP.processReport class.</P>

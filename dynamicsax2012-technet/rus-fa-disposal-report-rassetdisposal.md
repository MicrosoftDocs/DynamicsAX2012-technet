...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ955217(v=AX.60)
...
<td><p>RAssetDisposal</p></td>
</tr>
<tr class="even">
<td><p>Location of report in the AOT</p></td>
<td><p>SSRS Reports\Reports\RAssetDisposal</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Fixed assets (Russia)</strong> &gt; <strong>Reports</strong> &gt; <strong>FA disposal</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - RAssetDisposalTmp
    ...
    > [!NOTE]
    > <P>To find out where the data in the temp tables comes from, view the cross-references for the RAssetDisposalDP.processReport class.</P>

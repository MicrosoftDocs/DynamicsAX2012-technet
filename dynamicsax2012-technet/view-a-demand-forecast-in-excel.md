...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Dn497713(v=AX.60)
...
# View a demand forecast in Excel [AX 2012]
...
For more information about how to use PowerPivot tools, see [How to Use the SQL Server Data Mining Add-ins with PowerPivot for Excel](http://go.microsoft.com/fwlink/?linkid=335792%26clcid=0x409) and [Analytics in Microsoft Dynamics AX](analytics-in-microsoft-dynamics-ax.md).

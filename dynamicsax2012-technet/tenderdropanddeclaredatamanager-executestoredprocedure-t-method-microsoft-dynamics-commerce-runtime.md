---
title: TenderDropAndDeclareDataManager.ExecuteStoredProcedure(T) Method  (Microsoft.Dynamics.Commerce.Runtime)
TOCTitle: ExecuteStoredProcedure(T) Method
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.TenderDropAndDeclareDataManager.ExecuteStoredProcedure``1
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Dn696609(v=AX.60)
ms:contentKeyID: 62208008
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- ExecuteStoredProcedure
- Microsoft.Dynamics.Commerce.Runtime.TenderDropAndDeclareDataManager.ExecuteStoredProcedure
- TenderDropAndDeclareDataManager.ExecuteStoredProcedure
dev_langs:
- CSharp
- C++
- VB

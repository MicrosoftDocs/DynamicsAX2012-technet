---
title: EntityDataServiceRequest(TRequestEntity, TResponseEntity) Methods (Microsoft.Dynamics.Commerce.Runtime.DataServices.Messages)
TOCTitle: EntityDataServiceRequest(TRequestEntity, TResponseEntity) Methods
ms:assetid: Methods.T:Microsoft.Dynamics.Commerce.Runtime.DataServices.Messages.EntityDataServiceRequest`2
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Dn990030(v=AX.60)
ms:contentKeyID: 65320720
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# EntityDataServiceRequest(TRequestEntity, TResponseEntity) Methods

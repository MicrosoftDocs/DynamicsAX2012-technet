---
title: Telemarketing license code (smmTelemarketing)
TOCTitle: Telemarketing license code (smmTelemarketing)
ms:assetid: cc8a0649-b81a-42a2-9085-4817432af863
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh416689(v=AX.60)
ms:contentKeyID: 36931850
ms.date: 04/18/2014
mtps_version: v=AX.60
---

# Telemarketing license code (smmTelemarketing) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Telemarketing** license code enables access to the telemarketing features of Microsoft Dynamics AX.

## Configuration keys enabled by this license code

The following configuration keys are controlled by this license code:

[Telemarketing configuration key (SmmTM)](telemarketing-configuration-key-smmtm.md)

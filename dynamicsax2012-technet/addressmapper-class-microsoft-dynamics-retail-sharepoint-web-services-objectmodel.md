---
title: AddressMapper Class (Microsoft.Dynamics.Retail.SharePoint.Web.Services.ObjectModel)
TOCTitle: AddressMapper Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Services.ObjectModel.AddressMapper
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.services.objectmodel.addressmapper(v=AX.60)
ms:contentKeyID: 62202078
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Services.ObjectModel.AddressMapper
dev_langs:
- CSharp
- C++
- VB

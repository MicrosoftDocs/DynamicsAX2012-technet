...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.pos.contracts.services.icurrencyv1.getallcurrtypes(v=AX.60)
...
<!-- end list -->
  ...
  - currTypes  
    Type: [System.Collections.ArrayList](https://technet.microsoft.com/library/7x4b0a97\(v=ax.60\))  

---
title: Category consumption (2 periods) report (ProjConsumCateg2Prd)
TOCTitle: Category consumption (2 periods) report (ProjConsumCateg2Prd)
ms:assetid: 6c2cee95-9986-4513-bfd4-86b78f6905f5
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Bb147561(v=AX.60)
ms:contentKeyID: 36941269
ms.date: 04/18/2014
...
# Category consumption (2 periods) report (ProjConsumCateg2Prd) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

Use this report to analyze transactions by project category for two separate ledger periods.
...
<td><p>Select a transaction type that you want to include on the report. You can select more than one transaction type. You must select at least one transaction type.</p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><p><strong>Actual or budget</strong></p></td>
...
<td><p>SSRS Reports\Reports\ProjConsumCateg2Prd</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Project management and accounting</strong> &gt; <strong>Reports</strong> &gt; <strong>Project statements</strong> &gt; <strong>Consumption</strong> &gt; <strong>Consumption (2 periods)</strong> &gt; <strong>Category consumption (2 periods)</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - ProjListProjConsumptionCateg2PrdDP.processReport
...
> [!NOTE]
> <P>To determine where the data in the temp table comes from, view the cross-references for the ProjListProjConsumptionCateg2PrdDP.processReport class.</P>

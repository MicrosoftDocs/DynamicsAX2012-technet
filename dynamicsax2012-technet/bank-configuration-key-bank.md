...
# Bank configuration key (Bank) [AX 2012]
...
<td><p><a href="bel-archive-ibs-transaction-entries.md">(BEL) Archive IBS transaction entries</a></p></td>
</tr>
<tr class="even">
...
<td><p><a href="check-configuration-key-bankcheque.md">Check configuration key (BankCheque)</a></p>
<p><a href="deposit-slip-configuration-key-bankdeposit.md">Deposit slip configuration key (BankDeposit)</a></p>

...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Messages.GetSupportedCardTypesResponse.#ctor
...
Dim instance As New GetSupportedCardTypesResponse()
```

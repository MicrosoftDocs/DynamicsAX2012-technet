...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.services.pricingservice.getactivelistingpricepercatalog(v=AX.60)

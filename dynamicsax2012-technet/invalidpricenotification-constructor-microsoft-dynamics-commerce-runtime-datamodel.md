...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.invalidpricenotification.invalidpricenotification(v=AX.60)

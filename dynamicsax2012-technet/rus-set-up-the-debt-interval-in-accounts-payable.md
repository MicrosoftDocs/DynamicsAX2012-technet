---
title: (RUS) Set up the debt interval in Accounts payable
TOCTitle: (RUS) Set up the debt interval in Accounts payable
ms:assetid: bf77469c-78b2-4475-8ea2-a682a5b833e5
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ711571(v=AX.60)
ms:contentKeyID: 49387895
ms.date: 04/18/2014
mtps_version: v=AX.60
---

# (RUS) Set up the debt interval in Accounts payable [AX 2012]
...
1.  Click **Accounts payable** \> **Setup** \> **Profit tax** \> **Debt interval**.
...
5.  In the **Percent** field, enter the debt percentage, including the reserve.

6.  In the **Description** field, enter a description of the register field.
    

    > [!NOTE]
    > <P>On the <STRONG>General</STRONG> tab, the <STRONG>Debt type</STRONG> field displays the type of debt as <STRONG>Creditor debts</STRONG>.</P>

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.customersearchcriteria.searchonlycurrentcompany(v=AX.60)

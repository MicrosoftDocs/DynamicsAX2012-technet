...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.getdeviceconfigurationresponse.deviceconfiguration(v=AX.60)

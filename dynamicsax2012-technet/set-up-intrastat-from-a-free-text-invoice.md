...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Aa571224(v=AX.60)
...
7.  In the **Intrastat** form, click the **Transfer** button.
    ...
    > [!NOTE]
    > <P>The name of the button varies, depending on the country/region in which the legal entity is located. If Intrastat is not required for the legal entity’s country/region, the button is not displayed.</P>

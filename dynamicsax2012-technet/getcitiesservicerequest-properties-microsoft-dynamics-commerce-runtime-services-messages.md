---
title: GetCitiesServiceRequest Properties (Microsoft.Dynamics.Commerce.Runtime.Services.Messages)
TOCTitle: GetCitiesServiceRequest Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.GetCitiesServiceRequest
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.commerce.runtime.services.messages.getcitiesservicerequest_properties(v=AX.60)
ms:contentKeyID: 62214869
author: Khairunj
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetCitiesServiceRequest Properties


[!INCLUDE[archive-banner](includes/archive-banner.md)]

The [GetCitiesServiceRequest](getcitiesservicerequest-class-microsoft-dynamics-commerce-runtime-services-messages.md) type exposes the following members.

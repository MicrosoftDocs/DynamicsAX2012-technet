---
title: StockCountJournalTransaction.InventSizeId Property  (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: InventSizeId Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataModel.StockCountJournalTransaction.InventSizeId
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.stockcountjournaltransaction.inventsizeid(v=AX.60)
ms:contentKeyID: 62209944
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.StockCountJournalTransaction.InventSizeId
dev_langs:
- CSharp
- C++
- VB

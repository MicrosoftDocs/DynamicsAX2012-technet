...
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Workflow.WorkflowRequestHandler`2.Process
dev_langs:
- CSharp
- C++
- VB
...
<tbody>
<tr class="odd">
<td><img src="images/Dn990315.pub(en-us,AX.60).gif" title="Dn990321.pub(en-us,AX.60).gif" alt="Dn990321.pub(en-us,AX.60).gif" /></td>
...
<td><a href="workflowrequesthandler-trequest-tresponse-process-method-trequest-microsoft-dynamics-commerce-runtime-workflow.md">Process(TRequest)</a></td>
<td>Execute method to be overridden by each derived class.</td>
</tr>
</tbody>
</table>

---
title: ISalesOrderTransaction Properties (Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity)
TOCTitle: ISalesOrderTransaction Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity.ISalesOrderTransaction
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.dataentity.isalesordertransaction_properties(v=AX.60)
ms:contentKeyID: 49838543
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ISalesOrderTransaction Properties

The [ISalesOrderTransaction](isalesordertransaction-interface-microsoft-dynamics-retail-pos-contracts-dataentity.md) type exposes the following members.
...
[ISalesOrderTransaction Interface](isalesordertransaction-interface-microsoft-dynamics-retail-pos-contracts-dataentity.md)

---
title: ThrowIfNull Class (Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities)
TOCTitle: ThrowIfNull Class
...
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.ThrowIfNull
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public NotInheritable Class ThrowIfNull _
...
``` c++
public ref class ThrowIfNull sealed : public CodeActivity
```

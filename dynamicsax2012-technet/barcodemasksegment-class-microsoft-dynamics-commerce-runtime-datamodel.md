...
Public Class BarcodeMaskSegment _
...
public class BarcodeMaskSegment : CommerceEntity
```

``` c++
[DataContractAttribute]
public ref class BarcodeMaskSegment : public CommerceEntity
```

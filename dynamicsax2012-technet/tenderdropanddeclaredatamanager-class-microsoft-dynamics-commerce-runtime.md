---
title: TenderDropAndDeclareDataManager Class (Microsoft.Dynamics.Commerce.Runtime)
TOCTitle: TenderDropAndDeclareDataManager Class
ms:assetid: T:Microsoft.Dynamics.Commerce.Runtime.TenderDropAndDeclareDataManager
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.tenderdropanddeclaredatamanager(v=AX.60)
ms:contentKeyID: 62214369
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.TenderDropAndDeclareDataManager
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public NotInheritable Class TenderDropAndDeclareDataManager _
...
``` csharp
public sealed class TenderDropAndDeclareDataManager : TransactionLogDataManager
```

``` c++
public ref class TenderDropAndDeclareDataManager sealed : public TransactionLogDataManager
```

---
title: CreditMemoService.SupportedOperationIds Property  (Microsoft.Dynamics.Commerce.Runtime.Services)
TOCTitle: SupportedOperationIds Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.Services.CreditMemoService.SupportedOperationIds
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.services.creditmemoservice.supportedoperationids(v=AX.60)
ms:contentKeyID: 65319176
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Services.CreditMemoService.SupportedOperationIds
dev_langs:
- CSharp
- C++
- VB

...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.retailserverlibrary.odataextensions.commerceerrorhelper_methods(v=AX.60)
...
<td>Gets the odata error from <a href="https://technet.microsoft.com/library/c18k6c59(v=ax.60)">Exception</a>.</td>
</tr>
<tr class="even">
<td><img src="images/Dn987397.pubmethod(en-us,AX.60).gif" title="Public method" alt="Public method" /></td>

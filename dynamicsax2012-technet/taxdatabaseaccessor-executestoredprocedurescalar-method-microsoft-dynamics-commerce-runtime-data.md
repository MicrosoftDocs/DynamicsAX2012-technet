---
title: TaxDatabaseAccessor.ExecuteStoredProcedureScalar Method  (Microsoft.Dynamics.Commerce.Runtime.Data)
TOCTitle: ExecuteStoredProcedureScalar Method
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.Data.TaxDatabaseAccessor.ExecuteStoredProcedureScalar
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.taxdatabaseaccessor.executestoredprocedurescalar(v=AX.60)
ms:contentKeyID: 62212158
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- ExecuteStoredProcedureScalar
- Microsoft.Dynamics.Commerce.Runtime.Data.TaxDatabaseAccessor.ExecuteStoredProcedureScalar
- TaxDatabaseAccessor.ExecuteStoredProcedureScalar
dev_langs:
- CSharp
- C++
- VB

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.reasoncodedatabaseaccessor.buildsubreasoncodesquery(v=AX.60)

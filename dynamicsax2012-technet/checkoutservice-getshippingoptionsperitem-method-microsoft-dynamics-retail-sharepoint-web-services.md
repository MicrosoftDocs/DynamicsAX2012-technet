...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.services.checkoutservice.getshippingoptionsperitem(v=AX.60)

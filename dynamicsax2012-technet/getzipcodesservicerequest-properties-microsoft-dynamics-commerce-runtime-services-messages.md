---
title: GetZipCodesServiceRequest Properties (Microsoft.Dynamics.Commerce.Runtime.Services.Messages)
TOCTitle: GetZipCodesServiceRequest Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.GetZipCodesServiceRequest
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.services.messages.getzipcodesservicerequest_properties(v=AX.60)
ms:contentKeyID: 62211512
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetZipCodesServiceRequest Properties

The [GetZipCodesServiceRequest](getzipcodesservicerequest-class-microsoft-dynamics-commerce-runtime-services-messages.md) type exposes the following members.

---
title: ChannelDataSqliteDataRequestHandler.SupportedRequestTypes Property  (Microsoft.Dynamics.Commerce.Runtime.DataServices.Sqlite.Channel)
TOCTitle: SupportedRequestTypes Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataServices.Sqlite.Channel.ChannelDataSqliteDataRequestHandler.SupportedRequestTypes
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.sqlite.channel.channeldatasqlitedatarequesthandler.supportedrequesttypes(v=AX.60)
ms:contentKeyID: 65320507
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataServices.Sqlite.Channel.ChannelDataSqliteDataRequestHandler.SupportedRequestTypes
dev_langs:
- CSharp
- C++
- VB

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.services.stockcountrealtimeservice.supportedrequesttypes(v=AX.60)

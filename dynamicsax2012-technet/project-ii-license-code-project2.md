---
title: Project II license code (Project2)
TOCTitle: Project II license code (Project2)
ms:assetid: dd122c2c-9715-46fa-b2b4-ac665723ae4e
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh580492(v=AX.60)
ms:contentKeyID: 39518968
ms.date: 04/18/2014
mtps_version: v=AX.60
---

# Project II license code (Project2) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Project II** license code enables access to some advanced features of Microsoft Dynamics AX.

## Configuration keys enabled by this license code

The following configuration keys are controlled by this license code:

[Project II configuration key (ProjAdvanced)](project-ii-configuration-key-projadvanced.md)

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Aa573455(v=AX.60)
ms:contentKeyID: 62626034
ms.date: 07/28/2014
mtps_version: v=AX.60
---

# Create service object groups [AX 2012]
...
You can assign service objects to the group by using the **Service objects** form. For more information, see [Create service objects](create-service-objects.md).

---
title: (POL) Purchase VAT register (report)
TOCTitle: (POL) Purchase VAT register (report)
ms:assetid: 7c73bf11-9f0a-4a4a-a105-6111c1f407fc
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ863717(v=AX.60)
ms:contentKeyID: 50396400
ms.date: 04/18/2014
mtps_version: v=AX.60
---

# (POL) Purchase VAT register (report) [AX 2012]
...
<p>If you do not select this check box, the report displays detailed information about each tax transaction. The information includes voucher and invoice numbers, vendor names, and VAT register dates.</p></td>
</tr>
<tr class="even">
...
<td><p>TaxVatRegisterPurch</p></td>
</tr>
<tr class="even">
<td><p>Navigation to the report</p></td>
<td><p>Click <strong>General ledger</strong> &gt; <strong>Reports</strong> &gt; <strong>Transactions</strong> &gt; <strong>Periodic</strong> &gt; <strong>VAT registers</strong> &gt; <strong>Purchase VAT register</strong>.</p></td>
</tr>
</tbody>
</table>

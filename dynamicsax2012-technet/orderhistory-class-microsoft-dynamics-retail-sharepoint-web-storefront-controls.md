---
title: OrderHistory Class (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls)
TOCTitle: OrderHistory Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.OrderHistory
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sharepoint.web.storefront.controls.orderhistory(v=AX.60)
ms:contentKeyID: 62204216
author: tonyafehr
ms.date: 05/18/2015
...
``` vb
'Declaration
Public Class OrderHistory _
    Inherits BaseUserControl
'Usage
Dim instance As OrderHistory
```

``` csharp
public class OrderHistory : BaseUserControl
```

``` c++
public ref class OrderHistory : public BaseUserControl
```

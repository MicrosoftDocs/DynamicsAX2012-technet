...
ms:mtpsurl: https://technet.microsoft.com/library/Aa615393(v=AX.60)
...
<td><p>Click <strong>Select</strong> and select <strong>Yes</strong> for the <strong>Approved</strong> field to include only approved vendor invoice transactions. For information about how invoices are approved, see <a href="https://technet.microsoft.com/library/aa599011(v=ax.60)">Journal voucher - Vendor payment journal (form)</a>.</p></td>
</tr>
<tr class="even">

---
title: GetDeviceConfigurationRequest Methods (Microsoft.Dynamics.Commerce.Runtime.Messages)
TOCTitle: GetDeviceConfigurationRequest Methods
ms:assetid: Methods.T:Microsoft.Dynamics.Commerce.Runtime.Messages.GetDeviceConfigurationRequest
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.getdeviceconfigurationrequest_methods(v=AX.60)
ms:contentKeyID: 62205757
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetDeviceConfigurationRequest Methods

The [GetDeviceConfigurationRequest](getdeviceconfigurationrequest-class-microsoft-dynamics-commerce-runtime-messages.md) type exposes the following members.

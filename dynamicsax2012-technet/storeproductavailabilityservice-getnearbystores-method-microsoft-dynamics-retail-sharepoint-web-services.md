...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.services.storeproductavailabilityservice.getnearbystores(v=AX.60)

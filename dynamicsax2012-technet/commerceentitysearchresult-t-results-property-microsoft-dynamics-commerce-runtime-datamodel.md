...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Dn697410(v=AX.60)
...
Type: [System.Collections.ObjectModel.ReadOnlyCollection](https://technet.microsoft.com/en-us/library/ms132474\(v=ax.60\))\<[T](commerceentitysearchresult-t-class-microsoft-dynamics-commerce-runtime-datamodel.md)\>  

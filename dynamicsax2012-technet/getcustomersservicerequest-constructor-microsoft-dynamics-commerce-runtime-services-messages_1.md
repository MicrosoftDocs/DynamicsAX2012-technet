...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.GetCustomersServiceRequest.#ctor
...
Dim instance As New GetCustomersServiceRequest()
```

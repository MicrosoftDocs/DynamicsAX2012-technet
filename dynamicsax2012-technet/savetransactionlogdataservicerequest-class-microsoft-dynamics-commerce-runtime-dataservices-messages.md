...
# SaveTransactionLogDataServiceRequest Class
...
Public Class SaveTransactionLogDataServiceRequest _
...
public class SaveTransactionLogDataServiceRequest : DataRequest
```

``` c++
[DataContractAttribute]
public ref class SaveTransactionLogDataServiceRequest : public DataRequest
```

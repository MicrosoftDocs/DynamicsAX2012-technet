...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Dn193996(v=AX.60)
...
# Install the Microsoft Dynamics ERP RapidStart Connector for RapidStart Services [AX 2012]
...
1.  On the computer where the AOS instance is installed, download the current version of Microsoft Dynamics ERP RapidStart Connector from the following location:
    ...
    [Microsoft Dynamics ERP RapidStart Connector](http://go.microsoft.com/fwlink/?linkid=286818%26clcid=0x409).

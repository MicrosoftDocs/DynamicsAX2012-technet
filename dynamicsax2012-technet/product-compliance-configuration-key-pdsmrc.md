...
# Product compliance configuration key (PdsMRC) 
...
The **Product compliance** configuration key controls access to the forms, fields, and functions that are used to manage and administer product compliance in process manufacturing logistics.
...
<td><p><a href="set-up-product-compliance-parameters.md">Set up product compliance parameters</a></p></td>
</tr>
<tr class="odd">
<td><p><strong>Regulated products</strong></p></td>

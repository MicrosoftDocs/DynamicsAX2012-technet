---
title: LoyaltyRewardPoint.RewardPointId Property  (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: RewardPointId Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataModel.LoyaltyRewardPoint.RewardPointId
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.loyaltyrewardpoint.rewardpointid(v=AX.60)
ms:contentKeyID: 62214136
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.LoyaltyRewardPoint.RewardPointId
dev_langs:
- CSharp
- C++
- VB

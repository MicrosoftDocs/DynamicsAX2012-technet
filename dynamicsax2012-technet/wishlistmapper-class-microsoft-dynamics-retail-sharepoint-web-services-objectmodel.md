---
title: WishListMapper Class (Microsoft.Dynamics.Retail.SharePoint.Web.Services.ObjectModel)
TOCTitle: WishListMapper Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Services.ObjectModel.WishListMapper
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sharepoint.web.services.objectmodel.wishlistmapper(v=AX.60)
ms:contentKeyID: 62205979
author: Khairunj
ms.date: 05/18/2015
...
``` vb
'Declaration
Public NotInheritable Class WishListMapper
'Usage
...
``` c++
public ref class WishListMapper abstract sealed
```

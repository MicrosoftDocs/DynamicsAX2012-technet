---
title: ServerOfflineTransactionDataRequestHandler.SupportedRequestTypes Property  (Microsoft.Dynamics.Commerce.Runtime.DataServices.SqlServer)
...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.sqlserver.serverofflinetransactiondatarequesthandler.supportedrequesttypes(v=AX.60)
ms:contentKeyID: 65319408
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataServices.SqlServer.ServerOfflineTransactionDataRequestHandler.SupportedRequestTypes
dev_langs:
- CSharp
- C++
- VB

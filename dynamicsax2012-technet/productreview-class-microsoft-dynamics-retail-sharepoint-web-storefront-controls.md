---
title: ProductReview Class (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls)
TOCTitle: ProductReview Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.ProductReview
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.controls.productreview(v=AX.60)
ms:contentKeyID: 62202081
ms.date: 05/18/2015
...
``` vb
'Declaration
Public Class ProductReview _
    Inherits BaseUserControl
'Usage
Dim instance As ProductReview
```

``` csharp
public class ProductReview : BaseUserControl
```

``` c++
public ref class ProductReview : public BaseUserControl
```

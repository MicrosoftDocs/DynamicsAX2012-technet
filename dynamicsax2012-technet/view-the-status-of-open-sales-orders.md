...
# View the status of open sales orders [AX 2012]
...
1.  Click **Sales and marketing** \> **Inquiries** \> **Order status** \> **Open sales order lines**.

2.  On the **Overview** tab, select the order to check the status for.

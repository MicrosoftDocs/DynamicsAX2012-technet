...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.commerce.runtime.services.customerorder.preauthorization.paymentpropertiesblob(v=AX.60)

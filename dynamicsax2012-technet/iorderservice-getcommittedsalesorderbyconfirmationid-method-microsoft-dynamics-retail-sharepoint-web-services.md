...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.services.iorderservice.getcommittedsalesorderbyconfirmationid(v=AX.60)

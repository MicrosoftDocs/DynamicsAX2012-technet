...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.indiataxdatabaseaccessor.gettaxsummarysettingindia(v=AX.60)

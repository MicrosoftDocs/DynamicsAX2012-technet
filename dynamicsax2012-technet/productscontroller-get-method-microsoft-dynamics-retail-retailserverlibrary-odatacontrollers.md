...
f1_keywords:
- Microsoft.Dynamics.Retail.RetailServerLibrary.ODataControllers.ProductsController.Get
dev_langs:
- CSharp
- C++
- VB
...
<td><a href="productscontroller-get-method-microsoft-dynamics-retail-retailserverlibrary-odatacontrollers_1.md">Get()</a></td>
<td>Searches for the product. (Overrides EntitySetControllerGet().)</td>
</tr>
<tr class="even">
<td><img src="images/Dn987397.pubmethod(en-us,AX.60).gif" title="Public method" alt="Public method" /></td>
<td>Get(UTP)</td>

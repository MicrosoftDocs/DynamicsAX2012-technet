---
title: Worker/item profit and loss (actual vs. budget) report (ProjProfitLossEmpl2Column)
TOCTitle: Worker/item profit and loss (actual vs. budget) report (ProjProfitLossEmpl2Column)
ms:assetid: 13c4d7c1-30df-47e7-a09c-09abbcd6ac31
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Aa550650(v=AX.60)
...
# Worker/item profit and loss (actual vs. budget) report (ProjProfitLossEmpl2Column) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

Use this report to analyze profit or loss on projects by worker and item and to compare actual values to budgeted values.
...
<td><p>Click <strong>Select</strong>. In the <strong>Worker/item profit and loss (actual vs. budget)</strong> form, in the <strong>Criteria</strong> field, select an item number to include on the report. To add more than one item number, click <strong>Add</strong>.</p></td>
</tr>
<tr class="odd">
<td><p><strong>Service subscription</strong></p></td>
<td><p>Click <strong>Select</strong>. In the <strong>Worker/item profit and loss (actual vs. budget)</strong> form, in the <strong>Criteria</strong> field, select a service subscription to include on the report. To add more than one service subscription, click <strong>Add</strong>.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\ProjProfitLossEmpl2Column</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Project management and accounting</strong> &gt; <strong>Reports</strong> &gt; <strong>Project statements</strong> &gt; <strong>Profit and loss</strong> &gt; <strong>Profit and loss (actual vs. budget)</strong> &gt; <strong>Worker/item profit and loss (actual vs. budget)</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - ProjListProjProfitLossEmplItem2ColDP.processReport
...
> [!NOTE]
> <P>To determine where the data in the temp table comes from, view the cross-references for the ProjListProjProfitLossEmplItem2ColDP.processReport class.</P>

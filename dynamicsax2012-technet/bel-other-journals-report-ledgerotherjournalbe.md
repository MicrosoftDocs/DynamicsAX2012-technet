...
# (BEL) Other journals report (LedgerOtherJournalBE) [AX 2012]
...
<td><p>Select the journal name that was used when posting transactions to journals.</p></td>
</tr>
<tr class="even">
...
<td><p>The main ledger account where the transaction was posted.</p></td>
</tr>
<tr class="even">
<td><p><strong>Date</strong></p></td>
<td><p>The date when the subledger journal transaction was posted to the general journal.</p></td>
</tr>
<tr class="odd">
<td><p><strong>Voucher</strong></p></td>
<td><p>The voucher number in the subledger journal.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\LedgerOtherJournalBE</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>General ledger</strong> &gt; <strong>Reports</strong> &gt; <strong>Journals</strong> &gt; <strong>Other journals</strong>.</p></td>
</tr>
</tbody>
</table>
...
> [!NOTE]
> <P>To find out where the data in these temp tables come from, view the cross-references for the LedgerOtherJournalReportDPBE.processReport class.</P>

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.itemreservation.warehouseinventorydimensionid(v=AX.60)

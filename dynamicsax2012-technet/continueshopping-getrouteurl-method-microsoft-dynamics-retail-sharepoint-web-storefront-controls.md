---
title: ContinueShopping.GetRouteUrl Method  (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls)
TOCTitle: GetRouteUrl Method
ms:assetid: Overload:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.ContinueShopping.GetRouteUrl
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.controls.continueshopping.getrouteurl(v=AX.60)
ms:contentKeyID: 62205669
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- GetRouteUrl
- ContinueShopping.GetRouteUrl
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.ContinueShopping.GetRouteUrl
dev_langs:
- CSharp
- C++
- VB

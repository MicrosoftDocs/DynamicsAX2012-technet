...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.messages.validateemployeepassworddatarequest.passwordhash(v=AX.60)

---
title: WelcomeBar Class (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls)
TOCTitle: WelcomeBar Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.WelcomeBar
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sharepoint.web.storefront.controls.welcomebar(v=AX.60)
ms:contentKeyID: 62206234
author: Khairunj
ms.date: 05/18/2015
...
Control for displaying the Welcome bar.
...
``` vb
'Declaration
Public Class WelcomeBar _
    Inherits BaseUserControl
'Usage
Dim instance As WelcomeBar
```

``` csharp
public class WelcomeBar : BaseUserControl
```

``` c++
public ref class WelcomeBar : public BaseUserControl
```

---
title: ContinueShopping Class (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls)
TOCTitle: ContinueShopping Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.ContinueShopping
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.controls.continueshopping(v=AX.60)
ms:contentKeyID: 62205255
ms.date: 05/18/2015
...
``` vb
'Declaration
Public Class ContinueShopping _
    Inherits BaseUserControl
'Usage
Dim instance As ContinueShopping
```

``` csharp
public class ContinueShopping : BaseUserControl
```

``` c++
public ref class ContinueShopping : public BaseUserControl
```

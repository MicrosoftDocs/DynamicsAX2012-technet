...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.indiataxdatabaseaccessor.getwarehouseaddressindia(v=AX.60)

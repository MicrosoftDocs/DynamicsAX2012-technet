---
title: DeleteSalesTransaction Constructor  (Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities)
TOCTitle: DeleteSalesTransaction Constructor
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.DeleteSalesTransaction.#ctor
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.workflowfoundation.activities.deletesalestransaction.deletesalestransaction(v=AX.60)
ms:contentKeyID: 65315480
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.DeleteSalesTransaction.#ctor
dev_langs:
- CSharp
- C++
- VB
...
# DeleteSalesTransaction Constructor
...
Dim instance As New DeleteSalesTransaction()
```

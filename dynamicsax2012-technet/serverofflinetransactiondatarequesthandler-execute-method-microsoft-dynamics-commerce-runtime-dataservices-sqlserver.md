...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.sqlserver.serverofflinetransactiondatarequesthandler.execute(v=AX.60)

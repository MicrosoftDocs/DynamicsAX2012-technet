...
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Services.PricingEngine.DiscountData.DiscountBase.GetDiscountApplications
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public MustOverride Function GetDiscountApplications ( _

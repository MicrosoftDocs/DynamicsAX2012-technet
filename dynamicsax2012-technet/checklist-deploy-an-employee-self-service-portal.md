...
# Checklist: Deploy an employee self-service portal [AX 2012]
...
The following table describes the tasks that you must complete to deploy Enterprise Portal. After you complete the tasks in this checklist, internal users can access the employee self-service portal in the network.

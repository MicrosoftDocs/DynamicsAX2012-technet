---
title: GetChannelConfigurationRequest Properties (Microsoft.Dynamics.Commerce.Runtime.Messages)
TOCTitle: GetChannelConfigurationRequest Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.Messages.GetChannelConfigurationRequest
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.getchannelconfigurationrequest_properties(v=AX.60)
ms:contentKeyID: 62207470
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetChannelConfigurationRequest Properties

The [GetChannelConfigurationRequest](getchannelconfigurationrequest-class-microsoft-dynamics-commerce-runtime-messages.md) type exposes the following members.

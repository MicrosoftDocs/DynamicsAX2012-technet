---
title: ChannelConfiguration Class (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: ChannelConfiguration Class
ms:assetid: T:Microsoft.Dynamics.Commerce.Runtime.DataModel.ChannelConfiguration
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.channelconfiguration(v=AX.60)
...
Public Class ChannelConfiguration _
...
public class ChannelConfiguration : CommerceEntity
```

``` c++
[DataContractAttribute]
public ref class ChannelConfiguration : public CommerceEntity
```

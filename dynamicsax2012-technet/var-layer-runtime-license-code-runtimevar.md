---
title: VAR layer runtime license code (RuntimeVAR)
TOCTitle: VAR layer runtime license code (RuntimeVAR)
ms:assetid: b0a4081b-d090-4e43-a49f-d1e023e81266
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh456318(v=AX.60)
ms:contentKeyID: 36997765
ms.date: 04/18/2014
mtps_version: v=AX.60
---

# VAR layer runtime license code (RuntimeVAR) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **VAR layer runtime** license code permits a user to install a model in the VAR layer.

## Configuration keys enabled by this license code

The following configuration keys are controlled by this license code:

[Var Runtime configuration key (RuntimeVAR)](var-runtime-configuration-key-runtimevar.md)

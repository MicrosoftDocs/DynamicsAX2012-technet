---
title: CreateHardwareStationTokenResult Class (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: CreateHardwareStationTokenResult Class
ms:assetid: T:Microsoft.Dynamics.Commerce.Runtime.DataModel.CreateHardwareStationTokenResult
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.createhardwarestationtokenresult(v=AX.60)
...
Public Class CreateHardwareStationTokenResult _
...
public class CreateHardwareStationTokenResult : CommerceEntity
```

``` c++
[DataContractAttribute]
public ref class CreateHardwareStationTokenResult : public CommerceEntity
```

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.services.ifiscalprinterv2.prohibitprintingreceiptonnonfiscalprinters(v=AX.60)

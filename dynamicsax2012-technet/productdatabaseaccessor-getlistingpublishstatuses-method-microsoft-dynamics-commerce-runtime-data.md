---
title: ProductDatabaseAccessor.GetListingPublishStatuses Method  (Microsoft.Dynamics.Commerce.Runtime.Data)
TOCTitle: GetListingPublishStatuses Method
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Data.ProductDatabaseAccessor.GetListingPublishStatuses(System.Collections.Generic.IEnumerable{System.Int64},Microsoft.Dynamics.Commerce.Runtime.ColumnSet)
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.productdatabaseaccessor.getlistingpublishstatuses(v=AX.60)
ms:contentKeyID: 62205205
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Data.ProductDatabaseAccessor.GetListingPublishStatuses
dev_langs:
- CSharp
- C++
- VB
...
Get listing publish statuses by product identifiers.
...
returnValue = instance.GetListingPublishStatuses(productIds, _
    columnSet)
```

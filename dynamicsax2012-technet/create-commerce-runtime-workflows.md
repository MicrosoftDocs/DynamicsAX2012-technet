            ...
            foreach (var lineItem in offerCollection)
            {
                ...
                switch (lineItem.DiscountMethod)
                {
                    case 0: // Percentage Discount
                        ...
                        {
                            element.ProductPromotionStatement = (typeOfDiscount == PeriodicDiscountOfferType.MultipleBuy) ? "Buy at least " + Decimal.ToInt32(lineItem.MinimumQuantity) + " and " : String.Empty;
                    ...
                    case 1: // Discount Amount
                        ...
                        break;
                    case 2: // Offer Price
                        element.ProductPromotionStatement = (typeOfDiscount == PeriodicDiscountOfferType.MultipleBuy) ? "Buy at least " + lineItem.MinimumQuantity + " " : "Buy ";

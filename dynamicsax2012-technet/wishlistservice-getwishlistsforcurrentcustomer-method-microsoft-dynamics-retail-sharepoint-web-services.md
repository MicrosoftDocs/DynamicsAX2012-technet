...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.services.wishlistservice.getwishlistsforcurrentcustomer(v=AX.60)

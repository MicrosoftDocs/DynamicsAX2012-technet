---
title: GetCardTypeRequestHandler.Context Property  (Microsoft.Dynamics.Commerce.Runtime.Workflow)
TOCTitle: Context Property
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.Workflow.GetCardTypeRequestHandler.Context
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.workflow.getcardtyperequesthandler.context(v=AX.60)
ms:contentKeyID: 65321843
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Context
- GetCardTypeRequestHandler.Context
- Microsoft.Dynamics.Commerce.Runtime.Workflow.GetCardTypeRequestHandler.Context
dev_langs:
- CSharp
- C++
- VB
...
<tbody>
<tr class="odd">
<td><img src="images/Dn990315.pub(en-us,AX.60).gif" title="Dn968722.pub(en-us,AX.60).gif" alt="Dn968722.pub(en-us,AX.60).gif" /></td>

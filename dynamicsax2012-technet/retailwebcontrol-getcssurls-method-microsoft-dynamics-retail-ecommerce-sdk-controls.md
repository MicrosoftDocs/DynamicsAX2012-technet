---
title: RetailWebControl.GetCssUrls Method  (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls)
TOCTitle: GetCssUrls Method
ms:assetid: M:Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.RetailWebControl.GetCssUrls
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.controls.retailwebcontrol.getcssurls(v=AX.60)
ms:contentKeyID: 65317901
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.RetailWebControl.GetCssUrls
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Protected Overridable Function GetCssUrls As Collection(Of String)
'Usage
...
``` c++
protected:
virtual Collection<String^>^ GetCssUrls()
```

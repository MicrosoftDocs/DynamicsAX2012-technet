---
title: IEFTInfoV1.CashBack Property  (Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity)
TOCTitle: CashBack Property
ms:assetid: P:Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity.IEFTInfoV1.CashBack
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.dataentity.ieftinfov1.cashback(v=AX.60)
ms:contentKeyID: 47129337
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity.IEFTInfoV1.CashBack
dev_langs:
- CSharp
- C++
- VB

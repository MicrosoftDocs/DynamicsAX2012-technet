---
title: SyncStockCountTransactionsFromAxServiceRequest Methods (Microsoft.Dynamics.Commerce.Runtime.Services.Messages)
TOCTitle: SyncStockCountTransactionsFromAxServiceRequest Methods
ms:assetid: Methods.T:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.SyncStockCountTransactionsFromAxServiceRequest
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.services.messages.syncstockcounttransactionsfromaxservicerequest_methods(v=AX.60)
ms:contentKeyID: 62206477
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# SyncStockCountTransactionsFromAxServiceRequest Methods

The [SyncStockCountTransactionsFromAxServiceRequest](syncstockcounttransactionsfromaxservicerequest-class-microsoft-dynamics-commerce-runtime-services-messages.md) type exposes the following members.

---
title: ShiftDataManager.ExecuteStoredProcedureScalar Method  (Microsoft.Dynamics.Commerce.Runtime.Data)
TOCTitle: ExecuteStoredProcedureScalar Method
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.Data.ShiftDataManager.ExecuteStoredProcedureScalar
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.shiftdatamanager.executestoredprocedurescalar(v=AX.60)
ms:contentKeyID: 62207730
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- ExecuteStoredProcedureScalar
- Microsoft.Dynamics.Commerce.Runtime.Data.ShiftDataManager.ExecuteStoredProcedureScalar
- ShiftDataManager.ExecuteStoredProcedureScalar
dev_langs:
- CSharp
- C++
- VB

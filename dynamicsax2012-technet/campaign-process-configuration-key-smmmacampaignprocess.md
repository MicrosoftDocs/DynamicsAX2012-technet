...
f1_keywords:
- Data_Dictionary.Configuration_Keys.smmMACampaignProcess
---

# Campaign process configuration key (smmMACampaignProcess) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Campaign process** configuration key allows you to create a process for campaigns. With this key enabled, you can create and assign a campaign process and an activity hierarchy to your campaign records.

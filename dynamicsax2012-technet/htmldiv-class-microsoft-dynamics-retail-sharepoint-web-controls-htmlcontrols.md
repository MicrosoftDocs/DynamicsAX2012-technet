---
title: HtmlDiv Class (Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls)
TOCTitle: HtmlDiv Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlDiv
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.controls.htmlcontrols.htmldiv(v=AX.60)
ms:contentKeyID: 62205672
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlDiv
dev_langs:
- CSharp
- C++
- VB
...
Public Class HtmlDiv _
    Inherits HtmlContainerControl
'Usage
Dim instance As HtmlDiv
```
...
``` c++
[ComVisibleAttribute(false)]
public ref class HtmlDiv : public HtmlContainerControl
```

---
title: RetailWebControl.GetScriptUrls Method  (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls)
TOCTitle: GetScriptUrls Method
ms:assetid: M:Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.RetailWebControl.GetScriptUrls
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.controls.retailwebcontrol.getscripturls(v=AX.60)
ms:contentKeyID: 65318231
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.RetailWebControl.GetScriptUrls
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Protected Overridable Function GetScriptUrls As Collection(Of String)
'Usage
...
``` c++
protected:
virtual Collection<String^>^ GetScriptUrls()
```

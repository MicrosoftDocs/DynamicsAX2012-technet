---
title: GetItemByIdRequest Class (Microsoft.Dynamics.Commerce.Runtime.Messages)
TOCTitle: GetItemByIdRequest Class
...
# GetItemByIdRequest Class


[!INCLUDE[archive-banner](includes/archive-banner.md)]

Retrieves the item using the specified item identifier.
...
Public NotInheritable Class GetItemByIdRequest _
    Inherits Request
'Usage
...
public sealed class GetItemByIdRequest : Request
```

``` c++
[DataContractAttribute]
public ref class GetItemByIdRequest sealed : public Request
```

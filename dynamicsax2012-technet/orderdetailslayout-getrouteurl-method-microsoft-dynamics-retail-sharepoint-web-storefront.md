---
title: OrderDetailsLayout.GetRouteUrl Method  (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront)
TOCTitle: GetRouteUrl Method
ms:assetid: Overload:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.OrderDetailsLayout.GetRouteUrl
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.orderdetailslayout.getrouteurl(v=AX.60)
ms:contentKeyID: 62206295
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- GetRouteUrl
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.OrderDetailsLayout.GetRouteUrl
- OrderDetailsLayout.GetRouteUrl
dev_langs:
- CSharp
- C++
- VB

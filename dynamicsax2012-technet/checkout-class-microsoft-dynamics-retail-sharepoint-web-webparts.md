---
title: Checkout Class (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts)
TOCTitle: Checkout Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.Checkout
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.checkout(v=AX.60)
ms:contentKeyID: 62207661
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.Checkout
dev_langs:
- CSharp
- C++
- VB
...
public class Checkout : RetailWebPart
```

``` c++
[ComVisibleAttribute(false)]
public ref class Checkout : public RetailWebPart
```

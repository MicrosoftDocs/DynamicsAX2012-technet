...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Messages.VerifyProductExistenceResponse.#ctor
...
Dim instance As New VerifyProductExistenceResponse()
```

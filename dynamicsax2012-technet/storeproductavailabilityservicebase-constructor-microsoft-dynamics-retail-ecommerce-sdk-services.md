---
title: StoreProductAvailabilityServiceBase Constructor  (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Services)
TOCTitle: StoreProductAvailabilityServiceBase Constructor
...
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Services.StoreProductAvailabilityServiceBase.#ctor
dev_langs:
- CSharp
- C++
- VB
...
# StoreProductAvailabilityServiceBase Constructor
...
Dim instance As New StoreProductAvailabilityServiceBase()
```

``` csharp
protected StoreProductAvailabilityServiceBase()
```

``` c++
protected:
StoreProductAvailabilityServiceBase()
```

...
Gets full list of categories as [IQueryable](https://technet.microsoft.com/library/bb495796\(v=ax.60\)).
...
Type: [System.Linq.IQueryable](https://technet.microsoft.com/library/bb351562\(v=ax.60\))\<Category\>  
The [IQueryable](https://technet.microsoft.com/library/bb495796\(v=ax.60\)) set of categories.  

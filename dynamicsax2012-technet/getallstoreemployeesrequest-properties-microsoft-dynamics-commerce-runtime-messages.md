---
title: GetAllStoreEmployeesRequest Properties (Microsoft.Dynamics.Commerce.Runtime.Messages)
TOCTitle: GetAllStoreEmployeesRequest Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.Messages.GetAllStoreEmployeesRequest
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.getallstoreemployeesrequest_properties(v=AX.60)
ms:contentKeyID: 62214962
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetAllStoreEmployeesRequest Properties

The [GetAllStoreEmployeesRequest](getallstoreemployeesrequest-class-microsoft-dynamics-commerce-runtime-messages.md) type exposes the following members.

---
title: Customer Class (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts)
TOCTitle: Customer Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.Customer
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.customer(v=AX.60)
ms:contentKeyID: 62206967
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.Customer
dev_langs:
- CSharp
- C++
- VB
...
public class Customer : RetailWebPart
```

``` c++
[ComVisibleAttribute(false)]
public ref class Customer : public RetailWebPart
```

---
title: LoginLayout Class (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront)
TOCTitle: LoginLayout Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.LoginLayout
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.loginlayout(v=AX.60)
ms:contentKeyID: 62204034
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.LoginLayout
dev_langs:
- CSharp
- C++
- VB
...
Public Class LoginLayout _
    Inherits RetailLayoutPage
'Usage
Dim instance As LoginLayout
```

``` csharp
[ComVisibleAttribute(false)]
public class LoginLayout : RetailLayoutPage
```

``` c++
[ComVisibleAttribute(false)]
public ref class LoginLayout : public RetailLayoutPage
```

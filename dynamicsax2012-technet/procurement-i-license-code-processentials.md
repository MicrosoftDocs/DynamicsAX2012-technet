---
title: Procurement I license code (ProcEssentials)
TOCTitle: Procurement I license code (ProcEssentials)
ms:assetid: d1965d6b-84ca-4730-a7cb-6d331a9e47ce
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh433471(v=AX.60)
ms:contentKeyID: 36941228
ms.date: 04/18/2014
mtps_version: v=AX.60
---

# Procurement I license code (ProcEssentials) 


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Procurement I** license code enables access to some procurement and sourcing features of Microsoft Dynamics AX.

## Configuration keys enabled by this license code

The following configuration keys are controlled by this license code:

[Procurement I configuration key (ProcEssentials)](procurement-i-configuration-key-processentials.md)

...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sharepoint.web.controls.controlfactory.createhiddeninput(v=AX.60)
...
Type: [System.Web.UI.HtmlControls.HtmlInputHidden](https://technet.microsoft.com/library/x2sy02b0\(v=ax.60\))  

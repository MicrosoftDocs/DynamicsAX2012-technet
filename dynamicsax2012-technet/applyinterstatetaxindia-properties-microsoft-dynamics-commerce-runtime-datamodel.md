---
title: ApplyInterStateTaxIndia Properties (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: ApplyInterStateTaxIndia Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.DataModel.ApplyInterStateTaxIndia
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.applyinterstatetaxindia_properties(v=AX.60)
ms:contentKeyID: 65316488
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ApplyInterStateTaxIndia Properties
...
<tr class="odd">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
<td><a href="applyinterstatetaxindia-isapplyinterstatetaxindia-property-microsoft-dynamics-commerce-runtime-datamodel.md">IsApplyInterStateTaxIndia</a></td>
<td>Gets a value indicating whether the a sales tax group can be specified for inter-state transactions.</td>
</tr>
<tr class="even">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>

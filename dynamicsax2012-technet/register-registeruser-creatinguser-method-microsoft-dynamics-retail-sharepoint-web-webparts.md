...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.register.registeruser_creatinguser(v=AX.60)
...
<!-- end list -->
  ...
  - e  
    Type: [System.Web.UI.WebControls.LoginCancelEventArgs](https://technet.microsoft.com/en-us/library/b9fyfx4w\(v=ax.60\))  

...
# (HUN) Set up charges codes for Intrastat 
...
2.  Create a charges code.

3.  Select the **Include into Intrastat** check box to include the charges posted for charges codes in the Intrastat report.

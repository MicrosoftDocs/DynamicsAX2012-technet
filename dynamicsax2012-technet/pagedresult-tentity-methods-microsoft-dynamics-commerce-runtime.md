---
title: PagedResult(TEntity) Methods (Microsoft.Dynamics.Commerce.Runtime)
TOCTitle: PagedResult(TEntity) Methods
ms:assetid: Methods.T:Microsoft.Dynamics.Commerce.Runtime.PagedResult`1
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Dn738942(v=AX.60)
ms:contentKeyID: 62209725
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# PagedResult(TEntity) Methods

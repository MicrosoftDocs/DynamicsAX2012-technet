...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.services.ipricingservice.getindependentproductpricediscount(v=AX.60)

...
Be sure to review the following information before you upgrade to Microsoft Dynamics AX 2012.
...
<tr class="even">
<td><p><a href="what-s-new-upgrade-features.md">What's new: Upgrade features</a></p></td>
...
Use the following topics on TechNet to upgrade to Microsoft Dynamics AX 2012. Testing the installation on source and target test systems is highly recommended.

[Upgrade overview and preparation](upgrade-overview-and-preparation.md)

[Upgrade scenarios](upgrade-scenarios.md)

[Post-upgrade tasks](post-upgrade-tasks.md)

[Upgrade checklist task reference](upgrade-checklist-task-reference.md)

  
See the following upgrade resources for additional information.
...
Use the following resources after you have upgraded to Microsoft Dynamics AX 2012.

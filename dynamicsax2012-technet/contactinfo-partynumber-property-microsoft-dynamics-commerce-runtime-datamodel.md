---
title: ContactInfo.PartyNumber Property  (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: PartyNumber Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataModel.ContactInfo.PartyNumber
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.contactinfo.partynumber(v=AX.60)
ms:contentKeyID: 62214758
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.ContactInfo.PartyNumber
dev_langs:
- CSharp
- C++
- VB

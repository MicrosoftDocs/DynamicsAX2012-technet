---
title: OrderMapper Methods (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Mappers)
TOCTitle: OrderMapper Methods
ms:assetid: Methods.T:Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Mappers.OrderMapper
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.core.mappers.ordermapper_methods(v=AX.60)
ms:contentKeyID: 65317612
ms.date: 05/18/2015
...
The [OrderMapper](ordermapper-class-microsoft-dynamics-retail-ecommerce-sdk-core-mappers.md) type exposes the following members.

---
title: Allocation configuration key (COSAllocation)
TOCTitle: Allocation configuration key (COSAllocation)
ms:assetid: ecf44a20-f500-4cf7-9d8a-35c0ae7dd81c
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Aa599847(v=AX.60)
ms:contentKeyID: 37072024
ms.date: 05/02/2014
mtps_version: v=AX.60
f1_keywords:
- Data_Dictionary.Configuration_Keys.COSAllocation
---

# Allocation configuration key (COSAllocation) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Allocation** configuration key controls access to allocation forms and functions.
...
<tbody>
<tr class="odd">
<td><p><strong>Allocations</strong></p></td>
<td><p>Allocations (Form)</p></td>
</tr>
</tbody>
</table>

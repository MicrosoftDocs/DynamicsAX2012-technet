...
ms:mtpsurl: https://technet.microsoft.com/library/Aa569707(v=AX.60)
...
Click **Cost accounting** \> **Setup** \> **Journal names**. For more information, see [Journal name (form)](https://technet.microsoft.com/library/aa590520\(v=ax.60\))

---
title: AddressDataRequestHandler Class (Microsoft.Dynamics.Commerce.Runtime.DataServices.Common)
TOCTitle: AddressDataRequestHandler Class
ms:assetid: T:Microsoft.Dynamics.Commerce.Runtime.DataServices.Common.AddressDataRequestHandler
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.common.addressdatarequesthandler(v=AX.60)
ms:contentKeyID: 65322506
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataServices.Common.AddressDataRequestHandler
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public Class AddressDataRequestHandler _
...
``` csharp
public class AddressDataRequestHandler : IRequestHandler
```

``` c++
public ref class AddressDataRequestHandler : IRequestHandler
```

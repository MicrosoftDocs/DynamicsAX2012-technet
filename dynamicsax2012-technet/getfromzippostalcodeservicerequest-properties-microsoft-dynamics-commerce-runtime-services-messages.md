---
title: GetFromZipPostalCodeServiceRequest Properties (Microsoft.Dynamics.Commerce.Runtime.Services.Messages)
TOCTitle: GetFromZipPostalCodeServiceRequest Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.GetFromZipPostalCodeServiceRequest
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.services.messages.getfromzippostalcodeservicerequest_properties(v=AX.60)
ms:contentKeyID: 62211151
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetFromZipPostalCodeServiceRequest Properties

The [GetFromZipPostalCodeServiceRequest](getfromzippostalcodeservicerequest-class-microsoft-dynamics-commerce-runtime-services-messages.md) type exposes the following members.

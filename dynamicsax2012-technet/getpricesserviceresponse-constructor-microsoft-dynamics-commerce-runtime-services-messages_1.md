...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.GetPricesServiceResponse.#ctor
...
Dim instance As New GetPricesServiceResponse()
```

...
View model for the delivery method.
...
Public NotInheritable Class DeliveryMethod _
...
public sealed class DeliveryMethod : IExtensibleDataObject
```

``` c++
[SerializableAttribute]
[DataContractAttribute]
public ref class DeliveryMethod sealed : IExtensibleDataObject
```

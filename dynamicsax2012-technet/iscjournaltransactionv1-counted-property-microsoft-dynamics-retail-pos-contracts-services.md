...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.services.iscjournaltransactionv1.counted(v=AX.60)
...
The [Decimal](https://technet.microsoft.com/en-us/library/1k2e8atx\(v=ax.60\)) decimal value.  

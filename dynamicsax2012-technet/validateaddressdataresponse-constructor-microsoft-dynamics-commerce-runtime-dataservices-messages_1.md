...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.DataServices.Messages.ValidateAddressDataResponse.#ctor
...
Dim instance As New ValidateAddressDataResponse()
```

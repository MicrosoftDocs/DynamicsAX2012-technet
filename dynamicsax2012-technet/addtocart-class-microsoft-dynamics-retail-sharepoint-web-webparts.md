---
title: AddToCart Class (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts)
TOCTitle: AddToCart Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.AddToCart
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.addtocart(v=AX.60)
ms:contentKeyID: 62207156
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.AddToCart
dev_langs:
- CSharp
- C++
- VB
...
public class AddToCart : RetailWebPart
```

``` c++
[ComVisibleAttribute(false)]
public ref class AddToCart : public RetailWebPart
```

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.throwif.undefined(v=AX.60)
...
#### Parameters
  ...
  - enumeration  
    Type: [System.Enum](https://technet.microsoft.com/en-us/library/1zt1ybx4\(v=ax.60\))  

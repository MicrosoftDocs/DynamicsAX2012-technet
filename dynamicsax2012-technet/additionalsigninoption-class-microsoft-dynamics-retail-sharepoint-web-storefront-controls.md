...
``` vb
'Declaration
Public Class AdditionalSignInOption _
    Inherits BaseUserControl
'Usage
Dim instance As AdditionalSignInOption
```

``` csharp
public class AdditionalSignInOption : BaseUserControl
```

``` c++
public ref class AdditionalSignInOption : public BaseUserControl
```

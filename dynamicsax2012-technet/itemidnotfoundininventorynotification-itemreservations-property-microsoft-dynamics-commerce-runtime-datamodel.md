...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.itemidnotfoundininventorynotification.itemreservations(v=AX.60)

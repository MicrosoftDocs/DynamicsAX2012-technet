...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.pos.contracts.triggers.itriggersv1.applicationtriggers(v=AX.60)
...
Type: [System.Collections.Generic.IEnumerable](https://technet.microsoft.com/library/9eekhta0\(v=ax.60\))\<[IApplicationTrigger](iapplicationtrigger-interface-microsoft-dynamics-retail-pos-contracts-triggers.md)\>  

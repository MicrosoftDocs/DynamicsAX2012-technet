...
Public NotInheritable Class GetButtonGridsByIdsCriteria
'Usage
...
public sealed class GetButtonGridsByIdsCriteria
```

``` c++
[DataContractAttribute]
public ref class GetButtonGridsByIdsCriteria sealed
```

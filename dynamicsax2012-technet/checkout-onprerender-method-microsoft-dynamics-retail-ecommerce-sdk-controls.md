---
title: Checkout.OnPreRender Method  (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls)
TOCTitle: OnPreRender Method
ms:assetid: M:Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.Checkout.OnPreRender(System.EventArgs)
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.controls.checkout.onprerender(v=AX.60)
ms:contentKeyID: 65317122
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.Checkout.OnPreRender
dev_langs:
- CSharp
- C++
- VB

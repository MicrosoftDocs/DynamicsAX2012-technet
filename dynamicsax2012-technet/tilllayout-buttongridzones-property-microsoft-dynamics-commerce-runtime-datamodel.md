...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.commerce.runtime.datamodel.tilllayout.buttongridzones(v=AX.60)
...
Type: [System.Collections.Generic.ICollection](https://technet.microsoft.com/library/92t2ye13\(v=ax.60\))\<[ButtonGridZone](buttongridzone-class-microsoft-dynamics-commerce-runtime-datamodel.md)\>  

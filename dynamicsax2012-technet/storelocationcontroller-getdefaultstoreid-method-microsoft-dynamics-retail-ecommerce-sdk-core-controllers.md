...
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Controllers.StoreLocationController.GetDefaultStoreId
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public Shared Function GetDefaultStoreId As Long
'Usage
Dim returnValue As Long

returnValue = StoreLocationController.GetDefaultStoreId()
```
...
``` c++
public:
static long long GetDefaultStoreId()
```

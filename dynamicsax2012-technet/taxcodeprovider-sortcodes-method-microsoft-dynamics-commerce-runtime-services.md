...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.services.taxcodeprovider.sortcodes(v=AX.60)
...
#### Parameters
  ...
  - codes  
    Type: [System.Collections.Generic.Dictionary](https://technet.microsoft.com/en-us/library/xfhwa508\(v=ax.60\))\<[String](https://technet.microsoft.com/en-us/library/s1wwdcbf\(v=ax.60\)), [TaxCode](taxcode-class-microsoft-dynamics-commerce-runtime-services.md)\>  

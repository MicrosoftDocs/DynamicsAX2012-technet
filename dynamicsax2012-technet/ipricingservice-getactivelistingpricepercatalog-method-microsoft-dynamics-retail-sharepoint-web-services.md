...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.services.ipricingservice.getactivelistingpricepercatalog(v=AX.60)

...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.GetCustomerGroupsServiceResponse.#ctor
...
Dim instance As New GetCustomerGroupsServiceResponse()
```

---
title: CookieException Constructor (String) (Microsoft.Dynamics.Retail.SharePoint.Web.Common)
TOCTitle: CookieException Constructor (String)
ms:assetid: M:Microsoft.Dynamics.Retail.SharePoint.Web.Common.CookieException.#ctor(System.String)
...
# CookieException Constructor (String)
...
Dim instance As New CookieException(message)
```

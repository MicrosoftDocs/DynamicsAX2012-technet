---
title: PickingListLine.InventStyleId Property  (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: InventStyleId Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataModel.PickingListLine.InventStyleId
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.pickinglistline.inventstyleid(v=AX.60)
ms:contentKeyID: 62211182
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.PickingListLine.InventStyleId
dev_langs:
- CSharp
- C++
- VB

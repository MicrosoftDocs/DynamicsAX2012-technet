---
title: GetStockCountRequestHandler.Context Property  (Microsoft.Dynamics.Commerce.Runtime.Workflow)
TOCTitle: Context Property
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.Workflow.GetStockCountRequestHandler.Context
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.workflow.getstockcountrequesthandler.context(v=AX.60)
ms:contentKeyID: 65317700
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Context
- GetStockCountRequestHandler.Context
- Microsoft.Dynamics.Commerce.Runtime.Workflow.GetStockCountRequestHandler.Context
dev_langs:
- CSharp
- C++
- VB
...
<tbody>
<tr class="odd">
<td><img src="images/Dn990315.pub(en-us,AX.60).gif" title="Dn966837.pub(en-us,AX.60).gif" alt="Dn966837.pub(en-us,AX.60).gif" /></td>

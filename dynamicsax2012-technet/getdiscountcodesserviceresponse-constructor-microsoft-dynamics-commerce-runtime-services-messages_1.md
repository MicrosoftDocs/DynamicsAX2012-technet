...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.GetDiscountCodesServiceResponse.#ctor
...
Dim instance As New GetDiscountCodesServiceResponse()
```

---
title: Set-AXReportServerConfiguration
TOCTitle: Set-AXReportServerConfiguration
...
## Syntax
    ...
    Set-AXReportServerConfiguration -Id <String> [-AOSName <String> ] [-Description <String> ] [-Instance <String> ] [-MarkAsDefault] [-PathName <String> ] [-ReportManagerUri <Uri> ] [-Server <String> ] [-ServicesAOSName <String> ] [-ServicesAOSWSDLPort <Int32> ] [-ServicesFilePath <String> ] [-SharePointIntegrated] [-WebServiceUri <Uri> ] [ <CommonParameters>]
...
This example sets the active configuration to the ID ReportServer01.

  

    C:\PS>Set-AXReportServerConfiguration -Id ReportServer01 

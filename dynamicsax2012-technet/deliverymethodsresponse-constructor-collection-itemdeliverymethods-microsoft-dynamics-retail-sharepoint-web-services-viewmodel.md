---
title: DeliveryMethodsResponse Constructor (Collection(ItemDeliveryMethods)) (Microsoft.Dynamics.Retail.SharePoint.Web.Services.ViewModel)
TOCTitle: DeliveryMethodsResponse Constructor (Collection(ItemDeliveryMethods))
ms:assetid: M:Microsoft.Dynamics.Retail.SharePoint.Web.Services.ViewModel.DeliveryMethodsResponse.#ctor(System.Collections.ObjectModel.Collection{Microsoft.Dynamics.Retail.SharePoint.Web.Services.ViewModel.ItemDeliveryMethods})
...
# DeliveryMethodsResponse Constructor (Collection(ItemDeliveryMethods))
...
Dim instance As New DeliveryMethodsResponse(itemDeliveryMethods)
```

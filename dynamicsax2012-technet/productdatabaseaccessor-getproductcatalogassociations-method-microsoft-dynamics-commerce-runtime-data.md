---
title: ProductDatabaseAccessor.GetProductCatalogAssociations Method  (Microsoft.Dynamics.Commerce.Runtime.Data)
TOCTitle: GetProductCatalogAssociations Method
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Data.ProductDatabaseAccessor.GetProductCatalogAssociations(System.Collections.Generic.IEnumerable{System.Int64})
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.productdatabaseaccessor.getproductcatalogassociations(v=AX.60)
ms:contentKeyID: 62212830
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Data.ProductDatabaseAccessor.GetProductCatalogAssociations
dev_langs:
- CSharp
- C++
- VB
...
The collection of associated catalog and product identifiers.  

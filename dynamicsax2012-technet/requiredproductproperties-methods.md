---
title: RequiredProductProperties Methods ()
TOCTitle: RequiredProductProperties Methods
ms:assetid: Methods.T:RequiredProductProperties
ms:mtpsurl: https://technet.microsoft.com/en-us/library/requiredproductproperties_methods(v=AX.60)
ms:contentKeyID: 65315953
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# RequiredProductProperties Methods

The [RequiredProductProperties](requiredproductproperties-class.md) type exposes the following members.

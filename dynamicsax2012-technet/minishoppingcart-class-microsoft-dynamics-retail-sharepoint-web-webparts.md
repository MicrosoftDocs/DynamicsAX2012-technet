---
title: MiniShoppingCart Class (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts)
TOCTitle: MiniShoppingCart Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.MiniShoppingCart
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.minishoppingcart(v=AX.60)
ms:contentKeyID: 62204399
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.MiniShoppingCart
dev_langs:
- CSharp
- C++
- VB
...
public class MiniShoppingCart : RetailWebPart
```

``` c++
[ComVisibleAttribute(false)]
public ref class MiniShoppingCart : public RetailWebPart
```

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Aa496996(v=AX.60)
...
1.  Click **Procurement and sourcing** \> **Inquiries** \> **Purchase orders** \> **Open purchase order lines**.

2.  On the **Overview** tab, select a purchase order line.

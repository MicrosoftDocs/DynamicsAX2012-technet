...
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.SP.Publishing.Connector.CommonUtilities.PagesName
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public Shared ReadOnly Property PagesName As String
    Get
'Usage
Dim value As String

value = CommonUtilities.PagesName
```

``` csharp
public static string PagesName { get; }
```

``` c++
public:
static property String^ PagesName {
    String^ get ();
}
```

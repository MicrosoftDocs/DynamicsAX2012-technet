---
title: LineDeliveryOption.DeliveryOptions Property  (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Models)
TOCTitle: DeliveryOptions Property
ms:assetid: P:Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Models.LineDeliveryOption.DeliveryOptions
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.core.models.linedeliveryoption.deliveryoptions(v=AX.60)
ms:contentKeyID: 65316612
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Models.LineDeliveryOption.DeliveryOptions
dev_langs:
- CSharp
- C++
- VB

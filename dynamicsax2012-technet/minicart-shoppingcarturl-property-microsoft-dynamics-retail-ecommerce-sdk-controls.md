---
title: MiniCart.ShoppingCartUrl Property  (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls)
TOCTitle: ShoppingCartUrl Property
ms:assetid: P:Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.MiniCart.ShoppingCartUrl
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.controls.minicart.shoppingcarturl(v=AX.60)
ms:contentKeyID: 65317576
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.MiniCart.ShoppingCartUrl
dev_langs:
- CSharp
- C++
- VB

...
f1_keywords:
- Process
- GetCustomerBalanceRequestHandler.Process
- Microsoft.Dynamics.Commerce.Runtime.Workflow.GetCustomerBalanceRequestHandler.Process
dev_langs:
- CSharp
- C++
- VB
...
<tbody>
<tr class="odd">
<td><img src="images/Dn990315.pub(en-us,AX.60).gif" title="Dn998319.pub(en-us,AX.60).gif" alt="Dn998319.pub(en-us,AX.60).gif" /></td>

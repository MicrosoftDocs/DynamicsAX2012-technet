---
title: OrderDetailsLayout.SetFocus Method  (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront)
TOCTitle: SetFocus Method
ms:assetid: Overload:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.OrderDetailsLayout.SetFocus
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.orderdetailslayout.setfocus(v=AX.60)
ms:contentKeyID: 62202946
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- SetFocus
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.OrderDetailsLayout.SetFocus
- OrderDetailsLayout.SetFocus
dev_langs:
- CSharp
- C++
- VB

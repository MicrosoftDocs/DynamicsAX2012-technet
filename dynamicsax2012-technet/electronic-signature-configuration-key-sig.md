...
# Electronic signature configuration key (SIG) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Electronic signature** configuration key controls access to electronic signature functionality. If this key is enabled, the administrator can set up electronic signature requirements for documents, and users can sign documents electronically.

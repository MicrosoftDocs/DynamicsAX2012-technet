...
# (RUS) Set up a register for standard expenses in current period [AX 2012]
...
9.  Click **General ledger** \> **Setup** \> **Profit tax** \> **Registers**.Click**Parameters** to set up any additional parameters for the register.

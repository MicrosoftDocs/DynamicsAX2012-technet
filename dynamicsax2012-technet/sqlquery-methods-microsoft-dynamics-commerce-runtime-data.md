---
title: SqlQuery Methods (Microsoft.Dynamics.Commerce.Runtime.Data)
TOCTitle: SqlQuery Methods
ms:assetid: Methods.T:Microsoft.Dynamics.Commerce.Runtime.Data.SqlQuery
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.sqlquery_methods(v=AX.60)
ms:contentKeyID: 65320068
ms.date: 05/18/2015
...
<td><a href="sqlquery-buildquery-method-microsoft-dynamics-commerce-runtime-data.md">BuildQuery</a></td>
<td>Builds the query to be executed against the database.</td>
</tr>
<tr class="even">
<td><img src="images/Dn987397.pubmethod(en-us,AX.60).gif" title="Public method" alt="Public method" /></td>

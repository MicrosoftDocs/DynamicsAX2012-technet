...
# (IND) Post service tax in purchase transaction using the Invoice pool excl. posting form [AX 2012]
...
> [!NOTE]
> <P>Transactions created in the <STRONG>Vendor Invoice Pool Excluding Posting Details</STRONG> can be posted through <STRONG>Invoice journal</STRONG> form.</P>

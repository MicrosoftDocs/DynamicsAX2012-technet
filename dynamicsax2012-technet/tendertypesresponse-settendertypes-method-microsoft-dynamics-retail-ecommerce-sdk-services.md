...
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Services.TenderTypesResponse.SetTenderTypes
dev_langs:
- CSharp
- C++
- VB
...
instance.SetTenderTypes(tenderTypes)
```

``` csharp
public void SetTenderTypes(

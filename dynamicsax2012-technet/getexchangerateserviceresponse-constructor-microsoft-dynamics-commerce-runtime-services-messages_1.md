...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.GetExchangeRateServiceResponse.#ctor
...
Dim instance As New GetExchangeRateServiceResponse()
```

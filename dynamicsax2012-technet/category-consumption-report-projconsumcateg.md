...
# Category consumption report (ProjConsumCateg) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

Use this report to analyze the amount of costs posted to project categories compared to the related project budget amounts.
...
<td><p>Select the transaction types that you want to include on the report. You can select more than one transaction type.</p></td>
</tr>
<tr class="odd">
...
<p><strong>From date</strong> / <strong>To date</strong></p></td>
<td><p>Specify a start date and end date for ledger transactions to include on the report.</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Select</strong>. In the <strong>Category consumption</strong> form, select the project categories to include on the report. To add more than one category, click <strong>Add</strong>.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\ProjConsumCateg</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Project management and accounting</strong> &gt; <strong>Reports</strong> &gt; <strong>Project statements</strong> &gt; <strong>Consumption</strong> &gt; <strong>Category consumption</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - ProjListProjConsumptionCategoryDP.processReport
...
> [!NOTE]
> <P>To determine where the data in the temp tables comes from, view the cross-references for the ProjListProjConsumptionCategoryDP.processReport class.</P>

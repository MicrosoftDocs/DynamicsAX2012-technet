---
title: ClaimsWebPart Class (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.ClaimsWebPart)
TOCTitle: ClaimsWebPart Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.ClaimsWebPart.ClaimsWebPart
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.claimswebpart.claimswebpart(v=AX.60)
ms:contentKeyID: 62203880
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.ClaimsWebPart.ClaimsWebPart
dev_langs:
- CSharp
- C++
- VB
...
Public Class ClaimsWebPart _
    Inherits WebPart
'Usage
Dim instance As ClaimsWebPart
```
...
``` c++
[ComVisibleAttribute(false)]
public ref class ClaimsWebPart : public WebPart
```

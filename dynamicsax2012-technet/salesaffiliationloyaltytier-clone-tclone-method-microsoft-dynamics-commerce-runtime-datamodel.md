---
title: SalesAffiliationLoyaltyTier.Clone(TClone) Method  (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: Clone(TClone) Method
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.DataModel.SalesAffiliationLoyaltyTier.Clone``1
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Dn990952(v=AX.60)
ms:contentKeyID: 65322142
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.SalesAffiliationLoyaltyTier.Clone``1
dev_langs:
- CSharp
- C++
- VB

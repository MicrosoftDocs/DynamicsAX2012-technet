...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Messages.GetNextBatchListingPublishStatusesResponse.#ctor
...
Dim instance As New GetNextBatchListingPublishStatusesResponse()
```

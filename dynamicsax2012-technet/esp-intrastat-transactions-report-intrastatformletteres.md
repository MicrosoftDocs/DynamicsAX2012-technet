---
title: (ESP) Intrastat transactions report (IntrastatFormLetterES)
TOCTitle: (ESP) Intrastat transactions report (IntrastatFormLetterES)
ms:assetid: 5979ccbe-a9a3-45c1-8816-6cd22d284037
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh433494(v=AX.60)
ms:contentKeyID: 36941260
ms.date: 04/18/2014
...
# (ESP) Intrastat transactions report (IntrastatFormLetterES) [AX 2012]
...
<td><p>The sequence number for the Intrastat transaction in the shipment batch.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\ IntrastatFormLetterES</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Organization administration</strong> &gt; <strong>Periodic</strong> &gt; <strong>Foreign trade</strong> &gt; <strong>Intrastat</strong>. Click <strong>Output</strong> &gt; <strong>Form ES</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - IntrastatFormLetterTmpFR table
    ...
    > [!NOTE]
    > <P>To find out where the data in the temp table comes from, view the cross-references for the IntrastatFormLetterFR class.</P>

...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.SaveCustomerAccountActivationServiceRequest.#ctor
...
Dim instance As New SaveCustomerAccountActivationServiceRequest()
```

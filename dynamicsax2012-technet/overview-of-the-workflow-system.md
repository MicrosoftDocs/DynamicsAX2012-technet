...
# Overview of the workflow system [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

This topic provides an overview of the workflow system and describes the benefits that it provides.
...
Workflow is a system that is installed with Microsoft Dynamics AX and that runs on Application Object Server (AOS). The workflow system provides functionality that you can use to create individual workflows, or business processes.

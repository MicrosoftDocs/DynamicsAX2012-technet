---
title: User Log configuration key (SysUserLog)
TOCTitle: User Log configuration key (SysUserLog)
ms:assetid: 13ded26f-a7fb-4a36-a6b5-363289877bd5
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Aa550657(v=AX.60)
ms:contentKeyID: 36931816
ms.date: 05/02/2014
mtps_version: v=AX.60
f1_keywords:
- Data_Dictionary.Configuration_Keys.SysUserLog
---

# User Log configuration key (SysUserLog) [AX 2012]
...
<tbody>
<tr class="odd">
<td><p><strong>User log</strong></p></td>
<td><p><a href="https://technet.microsoft.com/en-us/library/aa551994(v=ax.60)">User log (form)</a></p></td>
</tr>
</tbody>
</table>

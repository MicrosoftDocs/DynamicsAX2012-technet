...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.common.currencydataservice.supportedrequesttypes(v=AX.60)

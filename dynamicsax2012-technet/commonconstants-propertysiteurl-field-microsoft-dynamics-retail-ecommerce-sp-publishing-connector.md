...
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.SP.Publishing.Connector.CommonConstants.PropertySiteUrl
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public Shared ReadOnly PropertySiteUrl As String
'Usage
Dim value As String

value = CommonConstants.PropertySiteUrl
```

``` csharp
public static readonly string PropertySiteUrl
```

``` c++
public:
static initonly String^ PropertySiteUrl
```

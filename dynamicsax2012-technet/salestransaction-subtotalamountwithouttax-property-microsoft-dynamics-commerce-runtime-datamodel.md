---
title: SalesTransaction.SubtotalAmountWithoutTax Property  (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: SubtotalAmountWithoutTax Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataModel.SalesTransaction.SubtotalAmountWithoutTax
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.salestransaction.subtotalamountwithouttax(v=AX.60)
ms:contentKeyID: 62208938
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.SalesTransaction.SubtotalAmountWithoutTax
dev_langs:
- CSharp
- C++
- VB

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.triggers.ioperationtriggerv1.postprocessoperation(v=AX.60)

...
# (BEL) Sales tax transactions re sales report (TaxSalesLedger) [AX 2012]
...
<td><p>Select the settlement period for the sales tax transactions.</p></td>
</tr>
<tr class="even">
<td><p><strong>From date</strong></p></td>
<td><p>Select the starting date of the settlement period.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\TaxSalesLedger</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>General ledger</strong> &gt; <strong>Reports</strong> &gt; <strong>Reconciliation</strong> &gt; <strong>Customer</strong> &gt; <strong>Sales tax transactions re sales</strong>.</p></td>
</tr>
</tbody>
</table>
...
> [!NOTE]
> <P>To find out where the data in the temp table comes from, view the cross-references for the TaxSalesLedgerDP.processReport class.</P>

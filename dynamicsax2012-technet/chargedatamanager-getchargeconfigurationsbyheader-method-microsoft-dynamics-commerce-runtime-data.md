...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.chargedatamanager.getchargeconfigurationsbyheader(v=AX.60)

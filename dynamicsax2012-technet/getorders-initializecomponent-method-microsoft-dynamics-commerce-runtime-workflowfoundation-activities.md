---
title: GetOrders.InitializeComponent Method  (Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities)
TOCTitle: InitializeComponent Method
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.GetOrders.InitializeComponent
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.workflowfoundation.activities.getorders.initializecomponent(v=AX.60)
ms:contentKeyID: 65322639
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.GetOrders.InitializeComponent
dev_langs:
- CSharp
- C++
- VB

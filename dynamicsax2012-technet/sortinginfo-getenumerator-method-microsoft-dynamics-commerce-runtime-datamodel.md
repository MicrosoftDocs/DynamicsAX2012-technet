...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.sortinginfo.getenumerator(v=AX.60)
...
Type: [System.Collections.Generic.List\<T\>.Enumerator](https://technet.microsoft.com/en-us/library/x854yt9s\(v=ax.60\))  

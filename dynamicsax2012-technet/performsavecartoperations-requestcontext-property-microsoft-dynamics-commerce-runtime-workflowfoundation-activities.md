---
title: PerformSaveCartOperations.RequestContext Property  (Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities)
TOCTitle: RequestContext Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.PerformSaveCartOperations.RequestContext
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.workflowfoundation.activities.performsavecartoperations.requestcontext(v=AX.60)
ms:contentKeyID: 65322771
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.PerformSaveCartOperations.RequestContext
dev_langs:
- CSharp
- C++
- VB

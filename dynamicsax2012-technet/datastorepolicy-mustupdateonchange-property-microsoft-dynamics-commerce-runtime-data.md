...
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Data.DataStorePolicy.MustUpdateOnChange
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public ReadOnly Property MustUpdateOnChange As Boolean
    Get
'Usage
Dim instance As DataStorePolicy
Dim value As Boolean

value = instance.MustUpdateOnChange
```

``` csharp
public bool MustUpdateOnChange { get; }
```

``` c++
public:
property bool MustUpdateOnChange {
    bool get ();
}
```

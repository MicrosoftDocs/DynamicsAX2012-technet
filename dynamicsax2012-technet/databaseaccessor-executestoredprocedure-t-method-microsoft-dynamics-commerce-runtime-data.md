---
title: DatabaseAccessor.ExecuteStoredProcedure(T) Method  (Microsoft.Dynamics.Commerce.Runtime.Data)
TOCTitle: ExecuteStoredProcedure(T) Method
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.Data.DatabaseAccessor.ExecuteStoredProcedure``1
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Dn718045(v=AX.60)
ms:contentKeyID: 62212663
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Data.DatabaseAccessor.ExecuteStoredProcedure``1
dev_langs:
- CSharp
- C++
- VB
...
<td>Executes the stored procedure using the specified parameters.</td>
</tr>
<tr class="even">
<td><img src="images/Dn987397.protmethod(en-us,AX.60).gif" title="Protected method" alt="Protected method" /></td>
...
<td>Executes the stored procedure using the specified parameters and returns the return value of the stored procedure as an integer.</td>
</tr>
</tbody>
</table>

---
title: ShiftsSqlDataRequestHandler Class (Microsoft.Dynamics.Commerce.Runtime.DataServices.SqlServer)
TOCTitle: ShiftsSqlDataRequestHandler Class
ms:assetid: T:Microsoft.Dynamics.Commerce.Runtime.DataServices.SqlServer.ShiftsSqlDataRequestHandler
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.sqlserver.shiftssqldatarequesthandler(v=AX.60)
ms:contentKeyID: 65320898
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataServices.SqlServer.ShiftsSqlDataRequestHandler
dev_langs:
- CSharp
- C++
- VB
...
# ShiftsSqlDataRequestHandler Class
...
``` vb
'Declaration
Public Class ShiftsSqlDataRequestHandler _
...
``` c++
public ref class ShiftsSqlDataRequestHandler : IRequestHandler
```

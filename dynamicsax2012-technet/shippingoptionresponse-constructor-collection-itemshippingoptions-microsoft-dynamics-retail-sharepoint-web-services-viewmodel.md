---
title: ShippingOptionResponse Constructor (Collection(ItemShippingOptions)) (Microsoft.Dynamics.Retail.SharePoint.Web.Services.ViewModel)
TOCTitle: ShippingOptionResponse Constructor (Collection(ItemShippingOptions))
ms:assetid: M:Microsoft.Dynamics.Retail.SharePoint.Web.Services.ViewModel.ShippingOptionResponse.#ctor(System.Collections.ObjectModel.Collection{Microsoft.Dynamics.Retail.SharePoint.Web.Services.ViewModel.ItemShippingOptions})
...
# ShippingOptionResponse Constructor (Collection(ItemShippingOptions))
...
Dim instance As New ShippingOptionResponse(itemShippingOptions)
```

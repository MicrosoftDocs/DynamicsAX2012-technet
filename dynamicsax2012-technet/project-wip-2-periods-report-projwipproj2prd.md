---
title: Project WIP (2 periods) report (ProjWIPProj2Prd)
TOCTitle: Project WIP (2 periods) report (ProjWIPProj2Prd)
ms:assetid: 826c63c3-62e5-46d2-a5c5-b053ef6a5856
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Aa615908(v=AX.60)
ms:contentKeyID: 36966704
ms.date: 04/18/2014
...
# Project WIP (2 periods) report (ProjWIPProj2Prd) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

Use this report to analyze work in progress transactions on projects for two specified date ranges.
...
<td><p>Select whether to display the quantity of hours, the cost value for hours posted to the project, or both on the report.</p></td>
</tr>
<tr class="odd">
<td><p><strong>Project</strong></p></td>
<td><p>Click <strong>Select</strong>. In the <strong>Project WIP (2 periods)</strong> form, in the <strong>Criteria</strong> field, select a project to include on the report. To add more than one project, click <strong>Add</strong>.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\ProjWIPProj2Prd</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Project management and accounting</strong> &gt; <strong>Reports</strong> &gt; <strong>Project statements</strong> &gt; <strong>WIP</strong> &gt; <strong>WIP (2 periods)</strong> &gt; <strong>Project WIP (2 periods)</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - ProjListProjWIPProj2PrdDP.processReport
...
> [!NOTE]
> <P>To determine where the data in the temp table comes from, view the cross-references for the ProjListProjWIPProj2PrdDP.processReport class.</P>

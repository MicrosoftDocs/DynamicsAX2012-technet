---
title: Warehouse management I license code (WMSBasic)
TOCTitle: Warehouse management I license code (WMSBasic)
ms:assetid: 05c92a00-d926-4cb0-a2e9-d75848be217a
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh433440(v=AX.60)
ms:contentKeyID: 36941190
ms.date: 04/18/2014
mtps_version: v=AX.60
---

# Warehouse management I license code (WMSBasic) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Warehouse management I** license code enables access to some administrative features of Microsoft Dynamics AX.

## Configuration keys enabled by this license code

The following configuration keys are controlled by this license code:

[Warehouse Management I configuration key (WMSBasic)](warehouse-management-i-configuration-key-wmsbasic.md)

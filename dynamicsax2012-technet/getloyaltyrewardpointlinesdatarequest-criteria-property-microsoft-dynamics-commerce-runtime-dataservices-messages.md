...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.messages.getloyaltyrewardpointlinesdatarequest.criteria(v=AX.60)

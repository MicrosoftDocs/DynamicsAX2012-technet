---
title: Quotations license code (Quotations)
TOCTitle: Quotations license code (Quotations)
ms:assetid: 0c753319-63fb-4771-aa44-e88c9289ae01
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh433441(v=AX.60)
ms:contentKeyID: 36941191
ms.date: 04/18/2014
mtps_version: v=AX.60
---

# Quotations license code (Quotations) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Quotations** license code enables access to the Microsoft Dynamics AX sales quotation module.

## Configuration keys enabled by this license code

The following configuration keys are controlled by this license code:

[Quotations configuration key (QuotationBasic)](quotations-configuration-key-quotationbasic.md)

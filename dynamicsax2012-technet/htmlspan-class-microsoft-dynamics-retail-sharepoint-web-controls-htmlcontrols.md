---
title: HtmlSpan Class (Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls)
TOCTitle: HtmlSpan Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlSpan
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.controls.htmlcontrols.htmlspan(v=AX.60)
ms:contentKeyID: 62203268
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlSpan
dev_langs:
- CSharp
- C++
- VB
...
Public Class HtmlSpan _
    Inherits HtmlContainerControl
'Usage
Dim instance As HtmlSpan
```
...
``` c++
[ComVisibleAttribute(false)]
public ref class HtmlSpan : public HtmlContainerControl
```

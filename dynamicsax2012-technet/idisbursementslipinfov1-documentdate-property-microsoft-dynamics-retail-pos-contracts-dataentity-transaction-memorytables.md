---
title: IDisbursementSlipInfoV1.DocumentDate Property  (Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity.Transaction.MemoryTables)
TOCTitle: DocumentDate Property
...
f1_keywords:
- Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity.Transaction.MemoryTables.IDisbursementSlipInfoV1.DocumentDate
dev_langs:
- CSharp
- C++
- VB
...
value = instance.DocumentDate

instance.DocumentDate = value
```

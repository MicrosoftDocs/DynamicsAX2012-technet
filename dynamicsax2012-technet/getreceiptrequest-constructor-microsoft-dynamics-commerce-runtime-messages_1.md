...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Messages.GetReceiptRequest.#ctor
...
Initializes a new instance of the GetReceiptRequest class.
...
Dim instance As New GetReceiptRequest()
```

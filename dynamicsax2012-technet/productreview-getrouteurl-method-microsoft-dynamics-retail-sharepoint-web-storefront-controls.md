---
title: ProductReview.GetRouteUrl Method  (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls)
TOCTitle: GetRouteUrl Method
ms:assetid: Overload:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.ProductReview.GetRouteUrl
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.controls.productreview.getrouteurl(v=AX.60)
ms:contentKeyID: 62206456
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- GetRouteUrl
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.ProductReview.GetRouteUrl
- ProductReview.GetRouteUrl
dev_langs:
- CSharp
- C++
- VB

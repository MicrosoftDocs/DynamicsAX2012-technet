---
title: PickingList.OrderType Property  (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: OrderType Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataModel.PickingList.OrderType
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.pickinglist.ordertype(v=AX.60)
ms:contentKeyID: 62212055
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.PickingList.OrderType
dev_langs:
- CSharp
- C++
- VB

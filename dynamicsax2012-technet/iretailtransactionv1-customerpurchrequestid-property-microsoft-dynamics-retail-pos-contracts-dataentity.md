...
f1_keywords:
- Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity.IRetailTransactionV1.CustomerPurchRequestId
dev_langs:
- CSharp
- C++
- VB
...
# CustomerPurchRequestId Property
...
``` vb
'Declaration
Property CustomerPurchRequestId As String
    Get
    Set
'Usage
...
value = instance.CustomerPurchRequestId

instance.CustomerPurchRequestId = value
```
...
``` c++
property String^ CustomerPurchRequestId {
    String^ get ();

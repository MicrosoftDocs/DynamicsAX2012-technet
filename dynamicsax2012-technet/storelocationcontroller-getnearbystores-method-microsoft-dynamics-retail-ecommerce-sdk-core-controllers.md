...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.ecommerce.sdk.core.controllers.storelocationcontroller.getnearbystores(v=AX.60)

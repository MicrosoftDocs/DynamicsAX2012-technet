---
title: GetLinkedProductsDataResponse.LinkedProducts Property  (Microsoft.Dynamics.Commerce.Runtime.DataServices.Messages)
TOCTitle: LinkedProducts Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataServices.Messages.GetLinkedProductsDataResponse.LinkedProducts
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.messages.getlinkedproductsdataresponse.linkedproducts(v=AX.60)
ms:contentKeyID: 65316959
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataServices.Messages.GetLinkedProductsDataResponse.LinkedProducts
dev_langs:
- CSharp
- C++
- VB

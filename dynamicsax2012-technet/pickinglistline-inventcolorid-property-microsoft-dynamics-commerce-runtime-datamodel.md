---
title: PickingListLine.InventColorId Property  (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: InventColorId Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataModel.PickingListLine.InventColorId
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.pickinglistline.inventcolorid(v=AX.60)
ms:contentKeyID: 62214772
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.PickingListLine.InventColorId
dev_langs:
- CSharp
- C++
- VB

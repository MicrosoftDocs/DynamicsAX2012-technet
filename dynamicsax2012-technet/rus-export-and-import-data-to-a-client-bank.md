...
Complete the following tasks before you create a client bank payment transaction:
  ...
  - Set up a bank account for a company. For more information, see [(RUS) Set up bank accounts](rus-set-up-bank-accounts.md) and [Bank accounts (form)](https://technet.microsoft.com/library/aa587660\(v=ax.60\)).

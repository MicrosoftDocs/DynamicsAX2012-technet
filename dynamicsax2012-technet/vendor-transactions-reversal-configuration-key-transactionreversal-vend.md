---
title: Vendor transactions reversal configuration key (TransactionReversal_Vend)
TOCTitle: Vendor transactions reversal configuration key (TransactionReversal_Vend)
ms:assetid: e72f42b5-fa4b-43bb-adde-2106065b7bed
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh467571(v=AX.60)
ms:contentKeyID: 36991718
ms.date: 05/02/2014
mtps_version: v=AX.60
---

# Vendor transactions reversal configuration key (TransactionReversal\_Vend) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Vendor transaction reversal** configuration key controls access to transaction reversal forms and functions. When this configuration key is enabled, the **Reverse transaction** option is available in the **Vendor transactions** form.

You can enable or disable this key in the **License configuration** form.

## Forms enabled or affected by the configuration key

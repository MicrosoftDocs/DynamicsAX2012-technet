...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.commerce.runtime.dataservices.common.taxdatarequesthandler.supportedrequesttypes(v=AX.60)

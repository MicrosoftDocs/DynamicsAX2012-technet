---
title: PromotionCode Class (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts)
TOCTitle: PromotionCode Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.PromotionCode
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.promotioncode(v=AX.60)
ms:contentKeyID: 62204638
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.PromotionCode
dev_langs:
- CSharp
- C++
- VB
...
public class PromotionCode : RetailWebPart
```

``` c++
[ComVisibleAttribute(false)]
public ref class PromotionCode : public RetailWebPart
```

---
title: ComponentKitVariantSet Constructor (Int64) (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: ComponentKitVariantSet Constructor (Int64)
...
# ComponentKitVariantSet Constructor (Int64)
...
Dim instance As New ComponentKitVariantSet(kitLineProductId)
```

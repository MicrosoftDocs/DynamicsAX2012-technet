---
title: (FRA) Customer account statement report (CustAccountStatement_FR)
TOCTitle: (FRA) Customer account statement report (CustAccountStatement_FR)
ms:assetid: 834534a5-e234-4c96-97ba-bc1bc9b904f2
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh433505(v=AX.60)
...
<td><p>Select the starting date of the date interval to generate the report for.</p></td>
</tr>
<tr class="even">
<td><p><strong>To date</strong></p></td>
<td><p>Select the ending date of the date interval to generate the report for.</p></td>
</tr>
<tr class="odd">
<td><p><strong>Assessment date</strong></p></td>
<td><p>Select the date until which only the open balance for the customer is calculated. For example, if you print the statement at the end of January and you want to know the open customer balance as of December 31, enter December 31 in this field.</p>
...
<td><p>Select this check box to display subtotals for each ledger account in the report.</p></td>
</tr>
<tr class="even">
...
<td><p>The customer account number to generate the report for. The information in this field is determined by your selections when you create a query.</p></td>
</tr>
<tr class="odd">
<td><p><strong>Customer group</strong></p></td>
<td><p>The customer group to generate the report for. The information in this field is determined by your selections when you create a query.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\CustAccountStatement_FR</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Accounts receivable</strong> &gt; <strong>Reports</strong> &gt; <strong>Transactions</strong> &gt; <strong>France</strong> &gt; <strong>Customer account statement</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - TmpCustVendAccountStatement\_FR table
    ...
    > [!NOTE]
    > <P>To find out where the data in the temp table comes from, view the cross-references for the CustAccountStatementDP_FR.processReport class.</P>

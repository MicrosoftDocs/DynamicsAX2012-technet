---
title: PickingList.OrderTypeValue Property  (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: OrderTypeValue Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataModel.PickingList.OrderTypeValue
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.pickinglist.ordertypevalue(v=AX.60)
ms:contentKeyID: 62208821
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.PickingList.OrderTypeValue
dev_langs:
- CSharp
- C++
- VB

...
# Training manager security role (HcmTrainingManager) [AX 2012]
...
<tbody>
<tr class="odd">
<td><p>Enable training process</p></td>
<td><p>HcmTrainingProcessEnable</p></td>
<td><p>Set up policies and reference data to enable the training process</p></td>
</tr>
<tr class="even">

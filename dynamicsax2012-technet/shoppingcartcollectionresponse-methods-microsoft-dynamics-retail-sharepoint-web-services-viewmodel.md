---
title: ShoppingCartCollectionResponse Methods (Microsoft.Dynamics.Retail.SharePoint.Web.Services.ViewModel)
TOCTitle: ShoppingCartCollectionResponse Methods
ms:assetid: Methods.T:Microsoft.Dynamics.Retail.SharePoint.Web.Services.ViewModel.ShoppingCartCollectionResponse
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sharepoint.web.services.viewmodel.shoppingcartcollectionresponse_methods(v=AX.60)
ms:contentKeyID: 62206075
author: Khairunj
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ShoppingCartCollectionResponse Methods

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Aa557249(v=AX.60)
...
# Project WIP (actual vs. budget) report (ProjWIPProj2Column) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

Use this report to analyze work in progress transactions on projects and to compare actual values to budgeted values for a specified date range.
...
<td><p>Click <strong>Select</strong>. In the <strong>Project WIP (actual vs. budget)</strong> form, select a project to include on the report. To add more than one project, click <strong>Add</strong>.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\ProjWIPProj2Column</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Project management and accounting</strong> &gt; <strong>Reports</strong> &gt; <strong>Project statements</strong> &gt; <strong>WIP</strong> &gt; <strong>WIP (actual vs budget)</strong> &gt; <strong>Project WIP (actual vs. budget)</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - ProjListProjWIPProj2ColDP.processReport
...
> [!NOTE]
> <P>To determine where the data in the temp table comes from, view the cross-references for the ProjListProjWIPProj2ColDP.processReport class.</P>

---
title: GetProductDataServiceRequest.ProductIds Property  (Microsoft.Dynamics.Commerce.Runtime.Services.Messages)
TOCTitle: ProductIds Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.GetProductDataServiceRequest.ProductIds
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.services.messages.getproductdataservicerequest.productids(v=AX.60)
ms:contentKeyID: 65316054
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Services.Messages.GetProductDataServiceRequest.ProductIds
dev_langs:
- CSharp
- C++
- VB

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.controls.address.country(v=AX.60)
...
Returns [HtmlSelect](https://technet.microsoft.com/en-us/library/xf11z4ad\(v=ax.60\)).  

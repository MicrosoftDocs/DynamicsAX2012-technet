---
title: SearchResultsLayout.InitOutputCache Method  (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront)
TOCTitle: InitOutputCache Method
ms:assetid: Overload:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.SearchResultsLayout.InitOutputCache
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sharepoint.web.storefront.searchresultslayout.initoutputcache(v=AX.60)
ms:contentKeyID: 62207166
author: Khairunj
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- InitOutputCache
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.SearchResultsLayout.InitOutputCache
- SearchResultsLayout.InitOutputCache
dev_langs:
- CSharp
- C++
- VB

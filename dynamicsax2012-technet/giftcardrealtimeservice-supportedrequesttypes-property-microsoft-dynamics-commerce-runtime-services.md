---
title: GiftCardRealtimeService.SupportedRequestTypes Property  (Microsoft.Dynamics.Commerce.Runtime.Services)
TOCTitle: SupportedRequestTypes Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.Services.GiftCardRealtimeService.SupportedRequestTypes
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.services.giftcardrealtimeservice.supportedrequesttypes(v=AX.60)
ms:contentKeyID: 65316642
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Services.GiftCardRealtimeService.SupportedRequestTypes
dev_langs:
- CSharp
- C++
- VB

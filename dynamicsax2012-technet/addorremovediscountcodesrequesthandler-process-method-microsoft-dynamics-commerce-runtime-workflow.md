---
title: AddOrRemoveDiscountCodesRequestHandler.Process Method  (Microsoft.Dynamics.Commerce.Runtime.Workflow)
...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.workflow.addorremovediscountcodesrequesthandler.process(v=AX.60)
ms:contentKeyID: 65317000
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Process
- AddOrRemoveDiscountCodesRequestHandler.Process
- Microsoft.Dynamics.Commerce.Runtime.Workflow.AddOrRemoveDiscountCodesRequestHandler.Process
dev_langs:
- CSharp
- C++
- VB
...
<tbody>
<tr class="odd">
<td><img src="images/Dn990315.pub(en-us,AX.60).gif" title="Dn998569.pub(en-us,AX.60).gif" alt="Dn998569.pub(en-us,AX.60).gif" /></td>

---
title: HtmlTemplate Class (Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls)
TOCTitle: HtmlTemplate Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlTemplate
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sharepoint.web.controls.htmlcontrols.htmltemplate(v=AX.60)
ms:contentKeyID: 62205980
author: Khairunj
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlTemplate
dev_langs:
- CSharp
- C++
- VB
...
Public Class HtmlTemplate _
    Inherits HtmlContainerControl
'Usage
Dim instance As HtmlTemplate
```

``` csharp
[ComVisibleAttribute(false)]
public class HtmlTemplate : HtmlContainerControl
```

``` c++
[ComVisibleAttribute(false)]
public ref class HtmlTemplate : public HtmlContainerControl
```

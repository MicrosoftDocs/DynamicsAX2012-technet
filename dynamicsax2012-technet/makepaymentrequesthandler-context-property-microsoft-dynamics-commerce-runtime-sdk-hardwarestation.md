---
title: MakePaymentRequestHandler.Context Property  (Microsoft.Dynamics.Commerce.Runtime.Sdk.HardwareStation)
TOCTitle: Context Property
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.Sdk.HardwareStation.MakePaymentRequestHandler.Context
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.sdk.hardwarestation.makepaymentrequesthandler.context(v=AX.60)
ms:contentKeyID: 65321257
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Context
- MakePaymentRequestHandler.Context
- Microsoft.Dynamics.Commerce.Runtime.Sdk.HardwareStation.MakePaymentRequestHandler.Context
dev_langs:
- CSharp
- C++
- VB
...
<tbody>
<tr class="odd">
<td><img src="images/Dn990315.pub(en-us,AX.60).gif" title="Dn990315.pub(en-us,AX.60).gif" alt="Dn990315.pub(en-us,AX.60).gif" /></td>

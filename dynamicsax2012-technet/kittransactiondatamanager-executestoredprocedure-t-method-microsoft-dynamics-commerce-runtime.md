---
title: KitTransactionDataManager.ExecuteStoredProcedure(T) Method  (Microsoft.Dynamics.Commerce.Runtime)
TOCTitle: ExecuteStoredProcedure(T) Method
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.KitTransactionDataManager.ExecuteStoredProcedure``1
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Dn694510(v=AX.60)
ms:contentKeyID: 62204923
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- ExecuteStoredProcedure
- KitTransactionDataManager.ExecuteStoredProcedure
- Microsoft.Dynamics.Commerce.Runtime.KitTransactionDataManager.ExecuteStoredProcedure
dev_langs:
- CSharp
- C++
- VB

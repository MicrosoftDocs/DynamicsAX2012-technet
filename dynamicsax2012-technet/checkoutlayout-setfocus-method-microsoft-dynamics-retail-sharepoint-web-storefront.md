---
title: CheckoutLayout.SetFocus Method  (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront)
TOCTitle: SetFocus Method
ms:assetid: Overload:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.CheckoutLayout.SetFocus
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.checkoutlayout.setfocus(v=AX.60)
ms:contentKeyID: 62207396
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- SetFocus
- CheckoutLayout.SetFocus
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.CheckoutLayout.SetFocus
dev_langs:
- CSharp
- C++
- VB

...
# Worker/item consumption (2 periods) report (ProjConsumEmpl2Prd) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

Use this report to analyze worker and item transactions by project for two separate periods.
...
> [!NOTE]
> <P>If you select <STRONG>Budget</STRONG>, you must also select a value in the <STRONG>Forecast model</STRONG> field.</P>
...
<td><p>Select whether to exclude expense and fee transactions that are not associated with a worker or item and any on-account transactions.</p></td>
</tr>
<tr class="even">
...
<td><p>Click <strong>Select</strong>. In the <strong>Worker/item consumption (2 periods)</strong> form, in the <strong>Criteria</strong> field, select an item number to include on the report. To add more than one item, click <strong>Add</strong>.</p></td>
</tr>
<tr class="even">
<td><p><strong>Worker</strong></p></td>
<td><p>Click <strong>Select</strong>. In the <strong>Worker/item consumption (2 periods)</strong> form, in the <strong>Criteria</strong> field, select a worker ID to include on the report. To add more than one worker, click <strong>Add</strong>.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\ProjConsumEmpl2Prd</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Project management and accounting</strong> &gt; <strong>Reports</strong> &gt; <strong>Project statements</strong> &gt; <strong>Consumption</strong> &gt; <strong>Consumption (2 periods)</strong> &gt; <strong>Worker/item consumption (2 periods)</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - ProjListProjConsumptionEmpl2PrdDP.processReport
...
> [!NOTE]
> <P>To determine where the data in the temp tables comes from, view the cross-references for the ProjListProjConsumptionEmpl2PrdDP.processReport class.</P>

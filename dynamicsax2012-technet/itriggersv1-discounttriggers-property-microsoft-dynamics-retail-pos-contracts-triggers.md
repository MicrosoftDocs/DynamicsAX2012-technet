...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.pos.contracts.triggers.itriggersv1.discounttriggers(v=AX.60)
...
Type: [System.Collections.Generic.IEnumerable](https://technet.microsoft.com/library/9eekhta0\(v=ax.60\))\<[IDiscountTrigger](idiscounttrigger-interface-microsoft-dynamics-retail-pos-contracts-triggers.md)\>  

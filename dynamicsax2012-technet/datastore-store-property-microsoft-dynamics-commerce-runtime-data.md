...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.datastore.store(v=AX.60)
...
Returns [IDisposable](https://technet.microsoft.com/en-us/library/aax125c9\(v=ax.60\)).  

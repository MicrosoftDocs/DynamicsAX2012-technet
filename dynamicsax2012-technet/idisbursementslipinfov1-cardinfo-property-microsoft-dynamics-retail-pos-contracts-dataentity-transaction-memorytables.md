...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.dataentity.transaction.memorytables.idisbursementslipinfov1.cardinfo(v=AX.60)

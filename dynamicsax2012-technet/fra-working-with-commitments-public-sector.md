...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh208607(v=AX.60)
...
# (FRA) Working with commitments (Public sector) [AX 2012]
...
> [!NOTE]
> <P>Commitments are available only if the following conditions are met:</P>
> <UL>
> <LI>

...
Public NotInheritable Class UseShiftResponse _
    Inherits ShiftResponse
'Usage
Dim instance As UseShiftResponse
```

``` csharp
[DataContractAttribute]
public sealed class UseShiftResponse : ShiftResponse
```

``` c++
[DataContractAttribute]
public ref class UseShiftResponse sealed : public ShiftResponse
```

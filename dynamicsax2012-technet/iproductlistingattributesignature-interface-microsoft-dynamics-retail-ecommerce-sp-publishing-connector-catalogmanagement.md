...
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.SP.Publishing.Connector.CatalogManagement.IProductListingAttributeSignature
dev_langs:
- CSharp
- C++
- VB
...
# IProductListingAttributeSignature Interface
...
``` vb
'Declaration
Public Interface IProductListingAttributeSignature
'Usage
...
``` c++
public interface class IProductListingAttributeSignature
```

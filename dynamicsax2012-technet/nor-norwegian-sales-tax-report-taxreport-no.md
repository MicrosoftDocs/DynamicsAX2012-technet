...
# (NOR) Norwegian sales tax report (TaxReport\_NO) [AX 2012]
...
<td><p>SSRS Reports\Reports\TaxReport_NO</p></td>
</tr>
<tr class="odd">
...
The data on this report comes from the following sources:
  ...
  - TaxReportTmp\_NO table


> [!NOTE]
> <P>To find out where the data in the temp table comes from, view the cross-references for the TaxReportDP_NO.processReport class.</P>

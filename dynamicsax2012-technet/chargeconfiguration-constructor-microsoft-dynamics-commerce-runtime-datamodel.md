...
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.ChargeConfiguration.#ctor
dev_langs:
- CSharp
- C++
- VB
...
# ChargeConfiguration Constructor


[!INCLUDE[archive-banner](includes/archive-banner.md)]

Initializes a new instance of the [ChargeConfiguration](chargeconfiguration-class-microsoft-dynamics-commerce-runtime-datamodel.md) class.
...
Dim instance As New ChargeConfiguration()
```

---
title: Optional APIs configuration key (SysAPI)
TOCTitle: Optional APIs configuration key (SysAPI)
ms:assetid: 7fbe9c50-610c-4067-a47e-fe8ff05ce6b7
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Aa615662(v=AX.60)
ms:contentKeyID: 36997758
ms.date: 05/02/2014
mtps_version: v=AX.60
f1_keywords:
- Data_Dictionary.Configuration_Keys.SysAPI
---

# Optional APIs configuration key (SysAPI) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Optional APIs** configuration key controls access to the **Dynamic data exchange api** and **Pipe client api** system classes.

Access to the rest of the system classes is controlled by the **X++ development** configuration key.

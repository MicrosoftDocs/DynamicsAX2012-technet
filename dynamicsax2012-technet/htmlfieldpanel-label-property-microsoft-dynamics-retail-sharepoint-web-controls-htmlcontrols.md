---
title: HtmlFieldPanel.Label Property  (Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls)
TOCTitle: Label Property
ms:assetid: P:Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlFieldPanel.Label
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.controls.htmlcontrols.htmlfieldpanel.label(v=AX.60)
ms:contentKeyID: 62205020
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlFieldPanel.Label
dev_langs:
- CSharp
- C++
- VB
...
Gets or sets the label control associated with the input.
...
``` vb
'Declaration
Public Property Label As HtmlLabel
    Get
    Set
'Usage
Dim instance As HtmlFieldPanel
Dim value As HtmlLabel
...
``` c++
public:
property HtmlLabel^ Label {
    HtmlLabel^ get ();
    void set (HtmlLabel^ value);
}
```
...
Returns [HtmlLabel](htmllabel-class-microsoft-dynamics-retail-sharepoint-web-controls-htmlcontrols.md).  

---
title: (SGP) Singaporean sales tax report (TaxReport_SG)
TOCTitle: (SGP) Singaporean sales tax report (TaxReport_SG)
ms:assetid: 3b247c08-8640-40cb-b27a-d386e451a698
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh371726(v=AX.60)
...
# (SGP) Singaporean sales tax report (TaxReport\_SG) [AX 2012]
...
<td><p>SSRS Reports\Reports\TaxReport_SG</p></td>
</tr>
<tr class="odd">
...
The data on this report comes from the following sources:
  ...
  - TaxReportTmp\_SG table


> [!NOTE]
> <P>To find out where the data in the temp table comes from, view the cross-references for the TaxReportDP_SG.processReport class.</P>

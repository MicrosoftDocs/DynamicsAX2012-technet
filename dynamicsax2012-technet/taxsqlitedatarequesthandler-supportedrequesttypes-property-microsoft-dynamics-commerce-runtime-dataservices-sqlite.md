...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.commerce.runtime.dataservices.sqlite.taxsqlitedatarequesthandler.supportedrequesttypes(v=AX.60)

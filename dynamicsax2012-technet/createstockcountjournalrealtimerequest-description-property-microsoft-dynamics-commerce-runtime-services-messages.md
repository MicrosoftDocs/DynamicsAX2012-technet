...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.services.messages.createstockcountjournalrealtimerequest.description(v=AX.60)

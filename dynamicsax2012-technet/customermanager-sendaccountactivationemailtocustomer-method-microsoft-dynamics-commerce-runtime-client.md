...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.client.customermanager.sendaccountactivationemailtocustomer(v=AX.60)

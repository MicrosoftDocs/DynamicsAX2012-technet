---
title: CustomerDisplay Class (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts)
TOCTitle: CustomerDisplay Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.CustomerDisplay
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.customerdisplay(v=AX.60)
ms:contentKeyID: 62206966
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.CustomerDisplay
dev_langs:
- CSharp
- C++
- VB
...
The customer web part allows for displaying customer data.
...
Public Class CustomerDisplay _
...
public class CustomerDisplay : RetailWebPart
```

``` c++
[ComVisibleAttribute(false)]
public ref class CustomerDisplay : public RetailWebPart
```

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.sqlserver.dataservices.reasoncodes.reasoncodesqlitedatarequesthandler.execute(v=AX.60)

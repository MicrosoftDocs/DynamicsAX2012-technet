---
title: Quality management license code (InventQualityManagement)
TOCTitle: Quality management license code (InventQualityManagement)
ms:assetid: 34e2d55a-029c-483b-9ba3-0b7df6ddd835
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh441662(v=AX.60)
ms:contentKeyID: 36993544
ms.date: 04/18/2014
mtps_version: v=AX.60
---

# Quality management license code (InventQualityManagement) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Quality management** license code enables access to quality management and quality control functionality in Microsoft Dynamics AX.

## Configuration keys enabled by this license code

The following configuration keys are controlled by this license code:

[Quality Management configuration key (InventQualityManagement)](quality-management-configuration-key-inventqualitymanagement.md)

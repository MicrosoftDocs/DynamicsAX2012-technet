...
f1_keywords:
- Data_Dictionary.Configuration_Keys.ProdShop
---

# Production Series III configuration key (ProdShop) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Production series III** configuration key controls access to some of the forms and functions that are used in production.

If this configuration key is enabled, you can perform job scheduling of production orders.
...
<tbody>
<tr class="odd">
<td><p><strong>Current production jobs</strong></p></td>
...
<td><p><strong>Production III</strong></p></td>
</tr>
<tr class="even">

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.minishoppingcart.op_implicit(v=AX.60)
ms:contentKeyID: 62201952
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.MiniShoppingCart.Implicit
dev_langs:
- CSharp
- C++
- VB
...
# Implicit Conversion (MiniShoppingCart to TemplateControl)
...
Public Shared Widening Operator CType ( _
    target As MiniShoppingCart _
) As TemplateControl
'Usage
Dim input As MiniShoppingCart
...
#### Parameters
  ...
  - target  
    Type: [Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.MiniShoppingCart](minishoppingcart-class-microsoft-dynamics-retail-sharepoint-web-webparts.md)  

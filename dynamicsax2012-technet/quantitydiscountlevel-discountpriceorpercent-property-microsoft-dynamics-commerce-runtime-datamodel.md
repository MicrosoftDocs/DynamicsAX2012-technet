...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.quantitydiscountlevel.discountpriceorpercent(v=AX.60)

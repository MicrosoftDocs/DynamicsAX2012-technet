...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.triggers.itriggersv1.infocodetriggers(v=AX.60)
...
Type: [System.Collections.Generic.IEnumerable](https://technet.microsoft.com/en-us/library/9eekhta0\(v=ax.60\))\<[IInfocodeTrigger](iinfocodetrigger-interface-microsoft-dynamics-retail-pos-contracts-triggers.md)\>  

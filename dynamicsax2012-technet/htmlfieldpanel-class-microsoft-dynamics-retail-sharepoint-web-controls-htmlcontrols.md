---
title: HtmlFieldPanel Class (Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls)
TOCTitle: HtmlFieldPanel Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlFieldPanel
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.controls.htmlcontrols.htmlfieldpanel(v=AX.60)
ms:contentKeyID: 62204091
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlFieldPanel
dev_langs:
- CSharp
- C++
- VB
...
public class HtmlFieldPanel : HtmlContainerControl
```

``` c++
[ComVisibleAttribute(false)]
public ref class HtmlFieldPanel : public HtmlContainerControl
```

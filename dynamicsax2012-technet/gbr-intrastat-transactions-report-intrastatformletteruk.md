---
title: (GBR) Intrastat transactions report (IntrastatFormLetterUK)
TOCTitle: (GBR) Intrastat transactions report (IntrastatFormLetterUK)
ms:assetid: 28066b32-83af-4e48-a9ad-b1dea72b6fe7
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh433486(v=AX.60)
...
# (GBR) Intrastat transactions report (IntrastatFormLetterUK) [AX 2012]
...
<td><p>SSRS Reports\Reports\IntrastatFormLetterUK</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Organization administration</strong> &gt; <strong>Periodic</strong> &gt; <strong>Foreign trade</strong> &gt; <strong>Intrastat</strong>. Click <strong>Output</strong> &gt; <strong>Form UK</strong>.</p></td>
</tr>
</tbody>
</table>

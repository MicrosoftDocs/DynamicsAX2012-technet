...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.shiftdataquerycriteria.searchbycurrentstaffid(v=AX.60)

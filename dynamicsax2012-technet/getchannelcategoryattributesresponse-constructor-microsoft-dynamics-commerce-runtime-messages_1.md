...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Messages.GetChannelCategoryAttributesResponse.#ctor
...
Dim instance As New GetChannelCategoryAttributesResponse()
```

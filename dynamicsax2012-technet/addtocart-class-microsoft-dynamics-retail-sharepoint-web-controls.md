---
title: AddToCart Class (Microsoft.Dynamics.Retail.SharePoint.Web.Controls)
TOCTitle: AddToCart Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Controls.AddToCart
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.controls.addtocart(v=AX.60)
ms:contentKeyID: 62201947
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Controls.AddToCart
dev_langs:
- CSharp
- C++
- VB
...
public class AddToCart : RetailWebControl
```

``` c++
[ComVisibleAttribute(false)]
public ref class AddToCart : public RetailWebControl
```

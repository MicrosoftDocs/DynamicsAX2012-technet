...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ721420(v=AX.60)
ms:contentKeyID: 49729985
ms.date: 04/18/2014
mtps_version: v=AX.60
---

# (LVA) Run a cash receipt update [AX 2012]
...
4.  In the **Batch no.** field, select the cash receipts batch identifier.
    ...
    > [!NOTE]
    > <P>You can view the selected ranges and their values in the <STRONG>Cash</STRONG> field.</P>

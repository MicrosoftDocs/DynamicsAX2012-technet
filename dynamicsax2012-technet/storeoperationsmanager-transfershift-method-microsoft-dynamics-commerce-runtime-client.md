...
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Client.StoreOperationsManager.TransferShift
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public Function TransferShift ( _
    shift As Shift _
) As Shift
'Usage
...
returnValue = instance.TransferShift(shift)
```

``` csharp
public Shift TransferShift(
    Shift shift
)
```

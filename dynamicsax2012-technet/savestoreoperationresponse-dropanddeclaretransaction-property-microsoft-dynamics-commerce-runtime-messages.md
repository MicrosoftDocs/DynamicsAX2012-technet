...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.savestoreoperationresponse.dropanddeclaretransaction(v=AX.60)

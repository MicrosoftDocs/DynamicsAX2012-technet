...
You can perform the following tasks to calculate taxes on customer orders in Retail:
  ...
  - Return a customer order completely or partially. When you return a customer order completely or partially, the complete or partial tax amounts that are posted with the customer order are reversed and updated in the **Voucher transactions** form. For more information, see [Voucher transactions (form)](https://technet.microsoft.com/library/aa583215\(v=ax.60\)).

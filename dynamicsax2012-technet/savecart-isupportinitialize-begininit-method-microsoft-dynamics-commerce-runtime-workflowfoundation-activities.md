---
title: SaveCart.ISupportInitialize.BeginInit Method  (Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities)
TOCTitle: ISupportInitialize.BeginInit Method
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.SaveCart.System#ComponentModel#ISupportInitialize#BeginInit
ms:mtpsurl: https://technet.microsoft.com/library/Dn989471(v=AX.60)
ms:contentKeyID: 65319931
author: Khairunj
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- ISupportInitialize.BeginInit
- Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.SaveCart.ISupportInitialize.BeginInit
- SaveCart.ISupportInitialize.BeginInit
dev_langs:
- CSharp
- C++
- VB
...
'Usage
Dim instance As SaveCart

CType(instance, ISupportInitialize).BeginInit()
```

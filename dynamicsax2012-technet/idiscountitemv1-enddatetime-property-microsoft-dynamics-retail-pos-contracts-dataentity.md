---
title: IDiscountItemV1.EndDateTime Property  (Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity)
TOCTitle: EndDateTime Property
ms:assetid: P:Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity.IDiscountItemV1.EndDateTime
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.dataentity.idiscountitemv1.enddatetime(v=AX.60)
ms:contentKeyID: 49829646
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity.IDiscountItemV1.EndDateTime
dev_langs:
- CSharp
- C++
- VB

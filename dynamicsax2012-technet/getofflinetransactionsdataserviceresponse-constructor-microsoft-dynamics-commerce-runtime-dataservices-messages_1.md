...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.DataServices.Messages.GetOfflineTransactionsDataServiceResponse.#ctor
...
Dim instance As New GetOfflineTransactionsDataServiceResponse()
```

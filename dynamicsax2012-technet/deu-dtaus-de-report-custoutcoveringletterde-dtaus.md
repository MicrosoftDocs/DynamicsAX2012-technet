...
# (DEU) DTAUS (DE) report (CustOutCoveringLetterDE\_DTAUS) [AX 2012]
...
<td><p>Select the currency code that is used for the customer payment transaction.</p></td>
</tr>
<tr class="odd">
...
<td><p>SSRS Reports\Reports\CustOutCoveringLetterDE_DTAUS</p></td>
</tr>
<tr class="odd">
<td><p>Menu item of the report</p></td>
<td><p>CustOutCoveringLetterReportDE_DTAUS</p></td>
</tr>
<tr class="even">
...
The data on this report comes from the following sources:
  ...
  - CustVendOutTmp table
    ...
    > [!NOTE]
    > <P>To find out where the data in the temp table comes from, view the cross-references for the CustOutCoveringLetterDP_DEDTAUS.processReport class.</P>

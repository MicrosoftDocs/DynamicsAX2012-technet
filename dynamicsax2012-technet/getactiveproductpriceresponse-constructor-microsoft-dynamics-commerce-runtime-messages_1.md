...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Messages.GetActiveProductPriceResponse.#ctor
...
Dim instance As New GetActiveProductPriceResponse()
```

---
title: GetCustomerGroupsDataRequest Properties (Microsoft.Dynamics.Commerce.Runtime.DataServices.Messages)
TOCTitle: GetCustomerGroupsDataRequest Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.DataServices.Messages.GetCustomerGroupsDataRequest
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.messages.getcustomergroupsdatarequest_properties(v=AX.60)
ms:contentKeyID: 65319933
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetCustomerGroupsDataRequest Properties

The [GetCustomerGroupsDataRequest](getcustomergroupsdatarequest-class-microsoft-dynamics-commerce-runtime-dataservices-messages.md) type exposes the following members.

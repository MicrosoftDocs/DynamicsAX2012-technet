...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.services.messages.getordersserviceresponse.getordersserviceresponse(v=AX.60)

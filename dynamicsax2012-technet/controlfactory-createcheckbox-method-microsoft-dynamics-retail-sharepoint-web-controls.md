...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sharepoint.web.controls.controlfactory.createcheckbox(v=AX.60)
...
Type: [System.Web.UI.HtmlControls.HtmlInputCheckBox](https://technet.microsoft.com/library/a2x9285k\(v=ax.60\))  
A checkbox instance.  

...
# (CHE) Payment advice report (VendOutPaymAdvice\_CHDTA) [AX 2012]
...
<td><p>VendOutPaymAdviceReportCH_DTA</p></td>
</tr>
<tr class="even">
<td><p>Location of report in the AOT</p></td>
<td><p>SSRS Reports\Reports\VendOutPaymAdvice_CHDTA</p></td>
</tr>
<tr class="odd">
...
The data on this report comes from the following sources:
  ...
  - CustVendOutTmp table
    ...
    > [!NOTE]
    > <P>To find out where the data in the temp table comes from, view the cross-references for the VendOutPaymAdviceDP_CHDTA.processReport class.</P>

---
title: GetReasonCodesServiceRequest Constructor (QueryResultSettings) (Microsoft.Dynamics.Commerce.Runtime.Services.Messages)
TOCTitle: GetReasonCodesServiceRequest Constructor (QueryResultSettings)
...
# GetReasonCodesServiceRequest Constructor (QueryResultSettings)
...
Dim instance As New GetReasonCodesServiceRequest(settings)
```

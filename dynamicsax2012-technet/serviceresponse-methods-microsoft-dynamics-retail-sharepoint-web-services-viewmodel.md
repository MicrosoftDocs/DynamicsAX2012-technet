---
title: ServiceResponse Methods (Microsoft.Dynamics.Retail.SharePoint.Web.Services.ViewModel)
TOCTitle: ServiceResponse Methods
ms:assetid: Methods.T:Microsoft.Dynamics.Retail.SharePoint.Web.Services.ViewModel.ServiceResponse
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.services.viewmodel.serviceresponse_methods(v=AX.60)
...
<td>Creates and instance of the <a href="responseerror-class-microsoft-dynamics-retail-sharepoint-web-services-viewmodel.md">ResponseError</a> and adds to Errors collection.</td>
</tr>
<tr class="even">
<td><img src="images/Dn987397.pubmethod(en-us,AX.60).gif" title="Public method" alt="Public method" /></td>

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.dataentity.ipostransactionv1.lastrunoperationisvalidpayment(v=AX.60)

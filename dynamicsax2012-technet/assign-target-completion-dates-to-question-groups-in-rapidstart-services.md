...
As the Customer administrator for a configuration project in Microsoft Dynamics ERP RapidStart Services, you can use this procedure to assign a target completion date to each group of questions in your configuration project. Target completion dates can help keep the work of answering questions on schedule.

  - The business experts know when they are expected to complete their work.

  - When you review progress reports for the project, you can see whether the business experts are on schedule to complete their work.

The target completion dates that you assign are based on Coordinated Universal Time (UTC), not a local system time.


> [!NOTE]
> <P>For information about how to review the progress of a project, see <A href="review-the-progress-on-questions-in-a-configuration-project-in-microsoft-dynamics-erp-rapidstart-services.md">Review the progress on questions in a configuration project in Microsoft Dynamics ERP RapidStart Services</A>.</P>
...
7.  On the **Projects** page, click the row of the configuration project in which to assign a business expert to a group of questions.
...
9.  At the top of the each question group box on the page, click the name of the person who is currently assigned to the question group.

10. In the **Reassign question group** form, next to the **Expected completion date** field, click the calendar button, and then select a date.
    

    > [!TIP]
    > <P>In the <STRONG>Reassign question group</STRONG> form, you can also reassign the question group to a different business expert.</P>

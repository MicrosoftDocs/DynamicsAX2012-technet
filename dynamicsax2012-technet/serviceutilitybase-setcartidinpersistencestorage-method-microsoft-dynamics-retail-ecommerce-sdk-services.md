...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.services.serviceutilitybase.setcartidinpersistencestorage(v=AX.60)

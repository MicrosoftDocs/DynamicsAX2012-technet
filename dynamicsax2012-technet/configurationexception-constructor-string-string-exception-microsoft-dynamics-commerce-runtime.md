---
title: ConfigurationException Constructor (String, String, Exception) (Microsoft.Dynamics.Commerce.Runtime)
TOCTitle: ConfigurationException Constructor (String, String, Exception)
...
# ConfigurationException Constructor (String, String, Exception)

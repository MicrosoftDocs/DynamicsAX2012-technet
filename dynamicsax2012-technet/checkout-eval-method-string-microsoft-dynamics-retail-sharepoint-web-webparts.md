---
title: Checkout.Eval Method (String) (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts)
TOCTitle: Eval Method (String)
ms:assetid: M:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.Checkout.Eval(System.String)
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sharepoint.web.webparts.checkout.eval(v=AX.60)
ms:contentKeyID: 62207557
author: Khairunj
ms.author: daxcpft
ms.date: 05/18/2015

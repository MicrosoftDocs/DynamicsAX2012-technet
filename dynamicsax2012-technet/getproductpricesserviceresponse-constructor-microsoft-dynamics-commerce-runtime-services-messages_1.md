...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.GetProductPricesServiceResponse.#ctor
...
Dim instance As New GetProductPricesServiceResponse()
```

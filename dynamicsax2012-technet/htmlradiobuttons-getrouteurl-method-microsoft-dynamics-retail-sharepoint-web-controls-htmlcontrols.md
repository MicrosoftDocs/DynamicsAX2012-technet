---
title: HtmlRadioButtons.GetRouteUrl Method  (Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls)
TOCTitle: GetRouteUrl Method
ms:assetid: Overload:Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlRadioButtons.GetRouteUrl
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.controls.htmlcontrols.htmlradiobuttons.getrouteurl(v=AX.60)
ms:contentKeyID: 62201922
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- GetRouteUrl
- HtmlRadioButtons.GetRouteUrl
- Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlRadioButtons.GetRouteUrl
dev_langs:
- CSharp
- C++
- VB

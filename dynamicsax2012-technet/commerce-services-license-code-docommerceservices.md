---
title: Commerce Services license code (DOCommerceServices)
TOCTitle: Commerce Services license code (DOCommerceServices)
ms:assetid: e1e4c924-3cda-42e6-b023-bf5dec4d0661
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh467570(v=AX.60)
ms:contentKeyID: 36991717
ms.date: 04/18/2014
mtps_version: v=AX.60
---

# Commerce Services license code (DOCommerceServices) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

The **Commerce Services** license code enables access to Commerce Services for Microsoft Dynamics ERP.

## Configuration keys enabled by this license code

The following configuration keys are controlled by this license code:

[Commerce Services configuration key (DOCommerceServices)](commerce-services-configuration-key-docommerceservices.md)

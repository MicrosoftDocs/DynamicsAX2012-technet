---
title: ITaxCodeV1.Exempt Property  (Microsoft.Dynamics.Retail.Pos.Contracts.BusinessObjects)
TOCTitle: Exempt Property
ms:assetid: P:Microsoft.Dynamics.Retail.Pos.Contracts.BusinessObjects.ITaxCodeV1.Exempt
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.businessobjects.itaxcodev1.exempt(v=AX.60)
ms:contentKeyID: 47128101
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Pos.Contracts.BusinessObjects.ITaxCodeV1.Exempt
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
ReadOnly Property Exempt As Boolean
    Get
'Usage

---
title: HtmlParagraph Class (Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls)
TOCTitle: HtmlParagraph Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlParagraph
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.controls.htmlcontrols.htmlparagraph(v=AX.60)
ms:contentKeyID: 62207493
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlParagraph
dev_langs:
- CSharp
- C++
- VB
...
Public Class HtmlParagraph _
    Inherits HtmlContainerControl
'Usage
Dim instance As HtmlParagraph
```
...
``` c++
[ComVisibleAttribute(false)]
public ref class HtmlParagraph : public HtmlContainerControl
```

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.controls.controlfactory.createoption(v=AX.60)
...
Creates an option to be used by the [HtmlSelect](https://technet.microsoft.com/en-us/library/xf11z4ad\(v=ax.60\)) element.
...
Type: [System.Web.UI.WebControls.ListItem](https://technet.microsoft.com/en-us/library/bb768tf6\(v=ax.60\))  

---
title: AddressDisplay Class (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts)
TOCTitle: AddressDisplay Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.AddressDisplay
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.addressdisplay(v=AX.60)
ms:contentKeyID: 62207029
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.AddressDisplay
dev_langs:
- CSharp
- C++
- VB
...
public class AddressDisplay : RetailWebPart
```

``` c++
[ComVisibleAttribute(false)]
public ref class AddressDisplay : public RetailWebPart
```

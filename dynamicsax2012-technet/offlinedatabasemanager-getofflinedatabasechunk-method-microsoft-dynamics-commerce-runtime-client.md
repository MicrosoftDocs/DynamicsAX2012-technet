...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.client.offlinedatabasemanager.getofflinedatabasechunk(v=AX.60)

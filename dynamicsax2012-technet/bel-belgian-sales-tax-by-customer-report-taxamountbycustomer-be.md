...
- (BEL)
- (BEL) Belgian sales tax by customer (TaxAmountByCustomer_BE)
- Belgian sales tax
- Belgian sales tax by customer
---

# (BEL) Belgian sales tax by customer report (TaxAmountByCustomer\_BE) [AX 2012]
...
<td><p>The customer account that is used to post the sales tax transactions.</p></td>
</tr>
<tr class="even">
...
<td><p>SSRS Reports\Report\TaxAmountByCustomer_BE</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>General ledger</strong> &gt; <strong>Periodic</strong> &gt; <strong>Sales tax payments</strong> &gt; <strong>Belgium</strong> &gt; <strong>Belgian sales tax by customer</strong>.</p></td>
</tr>
</tbody>
</table>

---
title: StockCountJournalTransaction.InventSerialId Property  (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: InventSerialId Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataModel.StockCountJournalTransaction.InventSerialId
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.stockcountjournaltransaction.inventserialid(v=AX.60)
ms:contentKeyID: 62209482
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.StockCountJournalTransaction.InventSerialId
dev_langs:
- CSharp
- C++
- VB

---
title: GetCurrenciesRequestHandler.Context Property  (Microsoft.Dynamics.Commerce.Runtime.Workflow)
TOCTitle: Context Property
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.Workflow.GetCurrenciesRequestHandler.Context
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.workflow.getcurrenciesrequesthandler.context(v=AX.60)
ms:contentKeyID: 65321087
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Context
- GetCurrenciesRequestHandler.Context
- Microsoft.Dynamics.Commerce.Runtime.Workflow.GetCurrenciesRequestHandler.Context
dev_langs:
- CSharp
- C++
- VB
...
<tbody>
<tr class="odd">
<td><img src="images/Dn990315.pub(en-us,AX.60).gif" title="Dn968472.pub(en-us,AX.60).gif" alt="Dn968472.pub(en-us,AX.60).gif" /></td>

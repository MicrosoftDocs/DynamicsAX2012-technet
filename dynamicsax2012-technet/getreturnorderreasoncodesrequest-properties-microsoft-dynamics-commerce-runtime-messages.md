---
title: GetReturnOrderReasonCodesRequest Properties (Microsoft.Dynamics.Commerce.Runtime.Messages)
TOCTitle: GetReturnOrderReasonCodesRequest Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.Messages.GetReturnOrderReasonCodesRequest
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.getreturnorderreasoncodesrequest_properties(v=AX.60)
ms:contentKeyID: 65322811
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetReturnOrderReasonCodesRequest Properties

The [GetReturnOrderReasonCodesRequest](getreturnorderreasoncodesrequest-class-microsoft-dynamics-commerce-runtime-messages.md) type exposes the following members.

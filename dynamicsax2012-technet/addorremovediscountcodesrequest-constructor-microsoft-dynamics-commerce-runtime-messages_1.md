...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Messages.AddOrRemoveDiscountCodesRequest.#ctor
...
Dim instance As New AddOrRemoveDiscountCodesRequest()
```

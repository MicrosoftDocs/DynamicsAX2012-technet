...
The Microsoft Dynamics AX Help viewer opens when you select **Help** from the client Help menu, or when you press F1 to view Help for a form. The Help viewer is a modified version of Microsoft Internet Explorer. To change accessibility settings in the Help viewer, you must open Internet Explorer *separately* from the Help viewer and enter your preferences there. For more information, see [accessibility options](https://go.microsoft.com/fwlink/?linkid=217525) for the latest releases of Internet Explorer.

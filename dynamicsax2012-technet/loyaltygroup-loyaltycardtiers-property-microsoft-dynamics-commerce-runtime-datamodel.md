...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.loyaltygroup.loyaltycardtiers(v=AX.60)
...
Type: [System.Collections.Generic.IList](https://technet.microsoft.com/en-us/library/5y536ey6\(v=ax.60\))\<[LoyaltyCardTier](loyaltycardtier-class-microsoft-dynamics-commerce-runtime-datamodel.md)\>  

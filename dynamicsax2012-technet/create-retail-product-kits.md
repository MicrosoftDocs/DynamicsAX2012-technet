...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Dn497863(v=AX.60)
...
![Set up retail product kits](images/Dn497863.SetupProductKits(AX.60).gif "Set up retail product kits")
...
![The overall kit process flow](images/Dn497863.KitBiggerProcess(AX.60).gif "The overall kit process flow")
...
<td><p>Before you can add products, product variants, and product substitutes to a product kit, you must set up your products in Microsoft Dynamics AX. For more information about how to set up retail products, see <a href="set-up-retail-products.md">Set up retail products</a>.</p></td>
</tr>
</tbody>
</table>
...
Create a new product, and designate it as a product kit. After you create the product kit, you can add products and product variants to the kit as your kit components. You can also add product substitutes for any of the kit components. For general information about how to create products in Microsoft Dynamics AX, see [Key tasks: Define products](key-tasks-define-products.md).

To create a product kit, follow these steps:

1.  Click **Retail** \> **Common** \> **Kits** \> **Product kits**.
...
For general information about how to release products to legal entities in Microsoft Dynamics AX, see [Key tasks: Release products](key-tasks-release-products.md).
...
6.  To verify that the product kit has been released to the selected legal entities, follow these steps:
    ...
    1.  Click **Retail** \> **Common** \> **Kits** \> **Released product kits**.
...
1.  Click **Retail** \> **Common** \> **Kits** \> **Released product kits**. On the **Released product kits** list page, double-click the product kit that you released in the previous task.
...
1.  Click **Retail** \> **Common** \> **Kits** \> **Released product kits**. On the **Released product kits** list page, double-click a released product kit in the list.

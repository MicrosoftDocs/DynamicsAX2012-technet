...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.retailserverlibrary.odatacontrollers.customerscontroller.get(v=AX.60)
...
Type: [System.Linq.IQueryable](https://technet.microsoft.com/en-us/library/bb351562\(v=ax.60\))\<Customer\>  
The [IQueryable](https://technet.microsoft.com/en-us/library/bb495796\(v=ax.60\)) of Customer.  

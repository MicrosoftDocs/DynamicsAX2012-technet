...
- balances
- balance
- SSRS_Reports.Reports.LedgerJournalAccountMovement
- balance report
- balances report
---
...
<td><p>The journal batch number that is determined by your selection when you create a query.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\LedgerJournalAccountMovement</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>General ledger</strong> &gt; <strong>Periodic</strong> &gt; <strong>Journals</strong> &gt; <strong>Periodic journals</strong>. Click <strong>Print</strong> &gt; <strong>Balances</strong>.</p></td>
</tr>
</tbody>
</table>
...
> [!NOTE]
> <P>To determine where the data in the temp table comes from, view the cross-references for the LedgerJournalAccountMovementDP.processReport class.</P>

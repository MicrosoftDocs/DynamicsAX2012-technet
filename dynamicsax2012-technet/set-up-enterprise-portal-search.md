...
# Set up Enterprise Portal Search [AX 2012]
...
Before users can perform searches from Enterprise Portal for Microsoft Dynamics AX or from the Microsoft Dynamics AX client, you must deploy Search. For more information, see [Install Microsoft Dynamics AX Enterprise Search](install-microsoft-dynamics-ax-enterprise-search.md).

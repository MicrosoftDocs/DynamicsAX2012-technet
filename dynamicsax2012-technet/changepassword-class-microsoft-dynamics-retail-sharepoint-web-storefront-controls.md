---
title: ChangePassword Class (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls)
TOCTitle: ChangePassword Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.ChangePassword
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.controls.changepassword(v=AX.60)
ms:contentKeyID: 62206557
ms.date: 05/18/2015
...
``` csharp
public class ChangePassword : BaseUserControl
```

``` c++
public ref class ChangePassword : public BaseUserControl
```

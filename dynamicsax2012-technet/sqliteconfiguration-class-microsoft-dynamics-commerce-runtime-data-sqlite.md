---
title: SqliteConfiguration Class (Microsoft.Dynamics.Commerce.Runtime.Data.Sqlite)
TOCTitle: SqliteConfiguration Class
ms:assetid: T:Microsoft.Dynamics.Commerce.Runtime.Data.Sqlite.SqliteConfiguration
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.sqlite.sqliteconfiguration(v=AX.60)
ms:contentKeyID: 65320756
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Data.Sqlite.SqliteConfiguration
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public NotInheritable Class SqliteConfiguration
'Usage
...
``` c++
public ref class SqliteConfiguration sealed
```

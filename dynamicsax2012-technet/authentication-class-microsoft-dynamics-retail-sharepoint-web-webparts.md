---
title: Authentication Class (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts)
TOCTitle: Authentication Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.Authentication
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.authentication(v=AX.60)
ms:contentKeyID: 62206780
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.Authentication
dev_langs:
- CSharp
- C++
- VB
...
public class Authentication : RetailWebPart
```

``` c++
[ComVisibleAttribute(false)]
public ref class Authentication : public RetailWebPart
```

---
title: Customer Class (Microsoft.Dynamics.Retail.SharePoint.Web.Controls)
TOCTitle: Customer Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Controls.Customer
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.controls.customer(v=AX.60)
ms:contentKeyID: 62205674
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Controls.Customer
dev_langs:
- CSharp
- C++
- VB
...
``` c++
[ComVisibleAttribute(false)]
public ref class Customer : public RetailWebControl
```

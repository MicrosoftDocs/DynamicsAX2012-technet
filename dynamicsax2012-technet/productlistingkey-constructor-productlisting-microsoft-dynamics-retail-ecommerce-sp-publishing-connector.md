---
title: ProductListingKey Constructor (ProductListing) (Microsoft.Dynamics.Retail.Ecommerce.SP.Publishing.Connector)
TOCTitle: ProductListingKey Constructor (ProductListing)
...
# ProductListingKey Constructor (ProductListing)
...
Dim instance As New ProductListingKey(listing)
```

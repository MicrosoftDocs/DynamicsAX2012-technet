...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.services.iloyaltyservice.getloyaltycardtransactions(v=AX.60)

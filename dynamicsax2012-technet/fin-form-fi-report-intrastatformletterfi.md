...
# (FIN) Form FI report (IntrastatFormLetterFI) [AX 2012]
...
<td><p>Enter the account number of the Intrastat service point for the trade authority.</p></td>
</tr>
<tr class="odd">
<td><p><strong>Handler</strong></p></td>
<td><p>Enter the personnel number of the worker who generates this report.</p></td>
</tr>
<tr class="even">
...
<td><p>SSRS Reports\Reports\IntrastatFormLetterFI</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Organization administration</strong> &gt; <strong>Periodic</strong> &gt; <strong>Foreign trade</strong> &gt; <strong>Intrastat</strong>. Click <strong>Output</strong> &gt; <strong>Form FI</strong>.</p></td>
</tr>
</tbody>
</table>
...
> [!NOTE]
> <P>To find out where the data in the temp table comes from, view the cross-references for the IntrastatFormLetterDPFI.processReport class.</P>

---
title: ProductReview Constructor  (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls)
TOCTitle: ProductReview Constructor
ms:assetid: M:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.ProductReview.#ctor
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.controls.productreview.productreview(v=AX.60)
ms:contentKeyID: 62206825
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.ProductReview.#ctor
dev_langs:
- CSharp
- C++
- VB
...
Dim instance As New ProductReview()
```

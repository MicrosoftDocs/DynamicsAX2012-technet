---
title: CheckoutLayout Class (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront)
TOCTitle: CheckoutLayout Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.CheckoutLayout
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.checkoutlayout(v=AX.60)
ms:contentKeyID: 62206215
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.CheckoutLayout
dev_langs:
- CSharp
- C++
- VB
...
Public Class CheckoutLayout _
    Inherits RetailLayoutPage
'Usage
Dim instance As CheckoutLayout
```

``` csharp
[ComVisibleAttribute(false)]
public class CheckoutLayout : RetailLayoutPage
```

``` c++
[ComVisibleAttribute(false)]
public ref class CheckoutLayout : public RetailLayoutPage
```

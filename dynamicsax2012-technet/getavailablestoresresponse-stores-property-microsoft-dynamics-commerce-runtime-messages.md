---
title: GetAvailableStoresResponse.Stores Property  (Microsoft.Dynamics.Commerce.Runtime.Messages)
TOCTitle: Stores Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.Messages.GetAvailableStoresResponse.Stores
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.getavailablestoresresponse.stores(v=AX.60)
ms:contentKeyID: 62209103
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Messages.GetAvailableStoresResponse.Stores
dev_langs:
- CSharp
- C++
- VB
...
Gets the collection of available stores.

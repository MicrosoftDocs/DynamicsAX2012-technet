...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.CustomersSearchServiceRequest.#ctor
...
Dim instance As New CustomersSearchServiceRequest()
```

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.controls.address.updatebutton(v=AX.60)
...
Returns [HtmlButton](https://technet.microsoft.com/en-us/library/9dy4xy15\(v=ax.60\)).  

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.getdeliveryoptionsrequest.fetchdeliveryoptionsforlines(v=AX.60)

...
# (LTU) Set up a number sequence code for the officials [AX 2012]
...
3.  In the **Number sequence code** field, select the number sequence code for the **Reference** type **Officials session ID**.

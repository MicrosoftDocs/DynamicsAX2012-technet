---
title: CashPaymentService.SupportedRequestTypes Property  (Microsoft.Dynamics.Commerce.Runtime.Services)
TOCTitle: SupportedRequestTypes Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.Services.CashPaymentService.SupportedRequestTypes
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.services.cashpaymentservice.supportedrequesttypes(v=AX.60)
ms:contentKeyID: 65319057
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Services.CashPaymentService.SupportedRequestTypes
dev_langs:
- CSharp
- C++
- VB

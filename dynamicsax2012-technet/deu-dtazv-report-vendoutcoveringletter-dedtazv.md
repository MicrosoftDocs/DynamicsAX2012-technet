---
title: (DEU) DTAZV report (VendOutCoveringLetter_DEDTAZV)
TOCTitle: (DEU) DTAZV report (VendOutCoveringLetter_DEDTAZV)
ms:assetid: 76e723b0-fd16-4423-a0a9-1f7490235c5e
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh352258(v=AX.60)
...
# (DEU) DTAZV report (VendOutCoveringLetter\_DEDTAZV) [AX 2012]
...
> [!NOTE]
> <P>You must clear the <STRONG>Control report</STRONG> check box to print the cover letter for the electronic vendor payment.</P>
...
<td><p>SSRS Reports\Reports\VendOutCoveringLetter_DEDTAZV</p></td>
</tr>
<tr class="odd">
...
The data on this report comes from the following sources:
  ...
  - VendOutCoveringLetterTmp\_DEDTAZV table
    

    > [!NOTE]
    > <P>To find out where the data in the temp table comes from, view the cross-references for the VendOutCoveringLetterDP_DEDTAZV.processReport class.</P>

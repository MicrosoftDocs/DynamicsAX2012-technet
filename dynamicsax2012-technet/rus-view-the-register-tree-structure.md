...
# (RUS) View the register tree structure [AX 2012]
...
Registers used in the profit tax calculation are displayed in a tree structure.

1.  Click **General ledger** \> **Setup** \> **Profit tax** \> **Registers**. form, Click **Tree** to view Register Tree.

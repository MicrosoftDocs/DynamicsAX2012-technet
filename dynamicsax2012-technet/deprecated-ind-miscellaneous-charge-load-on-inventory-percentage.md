...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Dn507089(v=AX.60)
ms:contentKeyID: 59623179
ms.date: 04/18/2014
mtps_version: v=AX.60
---

# Deprecated: (IND) Miscellaneous charge load on inventory percentage [AX 2012]
...
<p>For more information, see <a href="create-charges-codes.md">Create charges codes</a>, <a href="adjust-charges-on-vendor-invoices.md">Adjust charges on vendor invoices</a>, and <a href="https://technet.microsoft.com/en-us/library/jj677929(v=ax.60)">(IND) Allocate charges (modified form)</a>.</p></td>
</tr>
<tr class="odd">

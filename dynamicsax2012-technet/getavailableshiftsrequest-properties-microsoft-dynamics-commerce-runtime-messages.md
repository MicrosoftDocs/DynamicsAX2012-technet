---
title: GetAvailableShiftsRequest Properties (Microsoft.Dynamics.Commerce.Runtime.Messages)
TOCTitle: GetAvailableShiftsRequest Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.Messages.GetAvailableShiftsRequest
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.getavailableshiftsrequest_properties(v=AX.60)
ms:contentKeyID: 62211508
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetAvailableShiftsRequest Properties

The [GetAvailableShiftsRequest](getavailableshiftsrequest-class-microsoft-dynamics-commerce-runtime-messages.md) type exposes the following members.
...
<tr class="odd">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
<td><a href="getavailableshiftsrequest-status-property-microsoft-dynamics-commerce-runtime-messages.md">Status</a></td>
<td>Gets or sets the expected shift status.</td>
</tr>
</tbody>
</table>

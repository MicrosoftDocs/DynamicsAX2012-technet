---
title: SqliteDatabaseProvider Constructor  (Microsoft.Dynamics.Commerce.Runtime.Data.Sqlite)
TOCTitle: SqliteDatabaseProvider Constructor
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Data.Sqlite.SqliteDatabaseProvider.#ctor
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.commerce.runtime.data.sqlite.sqlitedatabaseprovider.sqlitedatabaseprovider(v=AX.60)
ms:contentKeyID: 65321626
author: Khairunj
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Data.Sqlite.SqliteDatabaseProvider.#ctor
dev_langs:
- CSharp
- C++
- VB
...
Dim instance As New SqliteDatabaseProvider()
```

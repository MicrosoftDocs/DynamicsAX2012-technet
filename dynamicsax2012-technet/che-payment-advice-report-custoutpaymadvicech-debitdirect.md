...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh404052(v=AX.60)
ms:contentKeyID: 36956721
ms.date: 04/18/2014
...
# (CHE) Payment advice report (CustOutPaymAdviceCH\_DebitDirect) [AX 2012]
...
The data on this report comes from the following sources:
  ...
  - CustVendOutTmp table
    ...
    > [!NOTE]
    > <P>To find out where the data in the temp table comes from, view the cross-references for the CustOutPaymAdviceDP_CHDebitDirect.processReport class.</P>

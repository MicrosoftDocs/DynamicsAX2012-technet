---
title: ShippingDataManager.ExecuteStoredProcedureScalar Method  (Microsoft.Dynamics.Commerce.Runtime.Data)
TOCTitle: ExecuteStoredProcedureScalar Method
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.Data.ShippingDataManager.ExecuteStoredProcedureScalar
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.shippingdatamanager.executestoredprocedurescalar(v=AX.60)
ms:contentKeyID: 62212547
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- ExecuteStoredProcedureScalar
- Microsoft.Dynamics.Commerce.Runtime.Data.ShippingDataManager.ExecuteStoredProcedureScalar
- ShippingDataManager.ExecuteStoredProcedureScalar
dev_langs:
- CSharp
- C++
- VB

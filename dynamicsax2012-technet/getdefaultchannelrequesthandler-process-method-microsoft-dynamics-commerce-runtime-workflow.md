---
title: GetDefaultChannelRequestHandler.Process Method  (Microsoft.Dynamics.Commerce.Runtime.Workflow)
TOCTitle: Process Method
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.Workflow.GetDefaultChannelRequestHandler.Process
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.workflow.getdefaultchannelrequesthandler.process(v=AX.60)
ms:contentKeyID: 65315911
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Process
- GetDefaultChannelRequestHandler.Process
- Microsoft.Dynamics.Commerce.Runtime.Workflow.GetDefaultChannelRequestHandler.Process
dev_langs:
- CSharp
- C++
- VB
...
<tbody>
<tr class="odd">
<td><img src="images/Dn990315.pub(en-us,AX.60).gif" title="Dn987355.pub(en-us,AX.60).gif" alt="Dn987355.pub(en-us,AX.60).gif" /></td>

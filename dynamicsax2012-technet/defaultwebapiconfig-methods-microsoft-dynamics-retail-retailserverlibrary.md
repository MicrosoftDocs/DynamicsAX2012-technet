---
title: DefaultWebApiConfig Methods (Microsoft.Dynamics.Retail.RetailServerLibrary)
TOCTitle: DefaultWebApiConfig Methods
ms:assetid: Methods.T:Microsoft.Dynamics.Retail.RetailServerLibrary.DefaultWebApiConfig
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.retailserverlibrary.defaultwebapiconfig_methods(v=AX.60)
ms:contentKeyID: 62202323
ms.date: 04/21/2014
mtps_version: v=AX.60
---

# DefaultWebApiConfig Methods

The [DefaultWebApiConfig](defaultwebapiconfig-class-microsoft-dynamics-retail-retailserverlibrary.md) type exposes the following members.
...
<tr class="even">
<td><img src="images/Dn987397.pubmethod(en-us,AX.60).gif" title="Public method" alt="Public method" /></td>
<td><a href="defaultwebapiconfig-register-method-microsoft-dynamics-retail-retailserverlibrary.md">Register</a></td>

---
title: GetStoresByEmployeeRequest Properties (Microsoft.Dynamics.Commerce.Runtime.Messages)
TOCTitle: GetStoresByEmployeeRequest Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.Messages.GetStoresByEmployeeRequest
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.getstoresbyemployeerequest_properties(v=AX.60)
ms:contentKeyID: 62210776
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetStoresByEmployeeRequest Properties

The [GetStoresByEmployeeRequest](getstoresbyemployeerequest-class-microsoft-dynamics-commerce-runtime-messages.md) type exposes the following members.

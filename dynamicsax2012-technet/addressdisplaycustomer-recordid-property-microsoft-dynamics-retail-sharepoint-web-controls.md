...
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Controls.AddressDisplayCustomer.RecordId
dev_langs:
- CSharp
- C++
- VB
...
Gets or sets the RecordId of the address.
...
``` vb
'Declaration
Public Property RecordId As HtmlSpan
    Get
    Private Set
'Usage
...
``` csharp
public HtmlSpan RecordId { get; private set; }
```

``` c++
public:
property HtmlSpan^ RecordId {
    HtmlSpan^ get ();

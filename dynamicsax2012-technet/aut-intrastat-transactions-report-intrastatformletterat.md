---
title: (AUT) Intrastat transactions report (IntrastatFormLetterAT)
TOCTitle: (AUT) Intrastat transactions report (IntrastatFormLetterAT)
ms:assetid: e07f804b-57e8-415f-aed5-8427dd6743c5
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Hh371731(v=AX.60)
ms:contentKeyID: 36814945
ms.date: 04/18/2014
...
# (AUT) Intrastat transactions report (IntrastatFormLetterAT) [AX 2012]
...
<td><p>SSRS Reports\Reports\IntrastatFormLetterAT</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Organization administration</strong> &gt; <strong>Periodic</strong> &gt; <strong>Foreign trade</strong> &gt; <strong>Intrastat</strong>. Click <strong>Output</strong> &gt; <strong>Form AT</strong>.</p></td>
</tr>
</tbody>
</table>

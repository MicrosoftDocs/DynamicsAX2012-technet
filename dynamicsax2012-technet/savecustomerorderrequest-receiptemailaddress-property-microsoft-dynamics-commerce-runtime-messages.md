...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.savecustomerorderrequest.receiptemailaddress(v=AX.60)

...
``` vb
'Declaration
Public NotInheritable Class DataColumnCollection _
    Inherits DbElementCollection(Of DataColumn)
'Usage
Dim instance As DataColumnCollection
```

``` csharp
public sealed class DataColumnCollection : DbElementCollection<DataColumn>
```

``` c++
public ref class DataColumnCollection sealed : public DbElementCollection<DataColumn^>
```

---
title: GetStoresRequest Properties (Microsoft.Dynamics.Commerce.Runtime.Messages)
TOCTitle: GetStoresRequest Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.Messages.GetStoresRequest
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.getstoresrequest_properties(v=AX.60)
ms:contentKeyID: 62211141
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetStoresRequest Properties

The [GetStoresRequest](getstoresrequest-class-microsoft-dynamics-commerce-runtime-messages.md) type exposes the following members.
...
<tr class="even">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
<td><a href="getstoresrequest-getallstores-property-microsoft-dynamics-commerce-runtime-messages.md">GetAllStores</a></td>
<td>Gets a value indicating whether this request the retrieval of all stores or a subset of them.</td>
</tr>
<tr class="odd">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
...
<tr class="even">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
<td><a href="getstoresrequest-storenumbers-property-microsoft-dynamics-commerce-runtime-messages.md">StoreNumbers</a></td>
<td>Gets or the collection of store numbers to search for.</td>
</tr>
</tbody>
</table>

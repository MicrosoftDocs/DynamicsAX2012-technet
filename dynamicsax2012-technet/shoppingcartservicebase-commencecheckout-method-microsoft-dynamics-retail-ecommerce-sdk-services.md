...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.services.shoppingcartservicebase.commencecheckout(v=AX.60)

---
title: GetLoyaltyCardStatusServiceRequest Properties (Microsoft.Dynamics.Commerce.Runtime.Services.Messages)
TOCTitle: GetLoyaltyCardStatusServiceRequest Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.Services.Messages.GetLoyaltyCardStatusServiceRequest
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.commerce.runtime.services.messages.getloyaltycardstatusservicerequest_properties(v=AX.60)
ms:contentKeyID: 62213069
author: Khairunj
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetLoyaltyCardStatusServiceRequest Properties

The [GetLoyaltyCardStatusServiceRequest](getloyaltycardstatusservicerequest-class-microsoft-dynamics-commerce-runtime-services-messages.md) type exposes the following members.
...
<tr class="odd">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
<td><a href="getloyaltycardstatusservicerequest-loyaltycardnumber-property-microsoft-dynamics-commerce-runtime-services-messages.md">LoyaltyCardNumber</a></td>
<td>Gets the loyalty card number.</td>
</tr>
<tr class="even">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
...
<tr class="even">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
<td><a href="getloyaltycardstatusservicerequest-retrievefutureloyaltycardtiers-property-microsoft-dynamics-commerce-runtime-services-messages.md">RetrieveFutureLoyaltyCardTiers</a></td>
<td>Gets or sets a value indicating whether to retrieve the loyalty card tiers that take effect in the future.</td>
</tr>
<tr class="odd">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
<td><a href="getloyaltycardstatusservicerequest-retrieverewardpointstatus-property-microsoft-dynamics-commerce-runtime-services-messages.md">RetrieveRewardPointStatus</a></td>
<td>Gets or sets a value indicating whether to retrieve the reward point status of the loyalty card.</td>
</tr>
</tbody>
</table>

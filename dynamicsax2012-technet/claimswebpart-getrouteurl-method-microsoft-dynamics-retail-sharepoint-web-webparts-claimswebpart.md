---
title: ClaimsWebPart.GetRouteUrl Method  (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.ClaimsWebPart)
TOCTitle: GetRouteUrl Method
ms:assetid: Overload:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.ClaimsWebPart.ClaimsWebPart.GetRouteUrl
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.claimswebpart.claimswebpart.getrouteurl(v=AX.60)
ms:contentKeyID: 62205852
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- GetRouteUrl
- ClaimsWebPart.GetRouteUrl
- Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.ClaimsWebPart.ClaimsWebPart.GetRouteUrl
dev_langs:
- CSharp
- C++
- VB

...
ms:assetid: M:Microsoft.Dynamics.Retail.Pos.Contracts.BusinessLogic.IUtilityV2.CreateSaleLineItem
...
``` vb
'Declaration
Function CreateSaleLineItem As ISaleLineItem
'Usage
Dim instance As IUtilityV2
Dim returnValue As ISaleLineItem

returnValue = instance.CreateSaleLineItem()
```

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.propertycolumnpair.property(v=AX.60)
...
Returns [PropertyInfo](https://technet.microsoft.com/en-us/library/8z852kf5\(v=ax.60\)).  

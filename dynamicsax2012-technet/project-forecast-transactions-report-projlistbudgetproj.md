---
title: Project forecast transactions report (ProjListBudgetProj)
TOCTitle: Project forecast transactions report (ProjListBudgetProj)
ms:assetid: 52e09b30-0178-4faf-964f-33762987e9d7
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Aa582720(v=AX.60)
ms:contentKeyID: 37832002
ms.date: 04/18/2014
mtps_version: v=AX.60
f1_keywords:
- SSRS_Reports.Reports.ProjListbudgetProj
---

# Project forecast transactions report (ProjListBudgetProj) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

Use this report to analyze budget forecasts by project for a specified date range.
...
<td><p>Click <strong>Select</strong>. In the <strong>Transaction list</strong> form, in the <strong>Criteria</strong> field, select a project category to include on the report. To add more than one project category, click <strong>Add</strong>.</p></td>
</tr>
<tr class="even">
...
<td><p>ProjListBudgetProj</p></td>
</tr>
<tr class="even">
<td><p>Navigation to the report</p></td>
<td><p>Click <strong>Project management and accounting</strong> &gt; <strong>Reports</strong> &gt; <strong>Transactions</strong> &gt; <strong>Forecast transactions</strong> &gt; <strong>Project forecast transactions</strong>.</p></td>
</tr>
</tbody>
</table>

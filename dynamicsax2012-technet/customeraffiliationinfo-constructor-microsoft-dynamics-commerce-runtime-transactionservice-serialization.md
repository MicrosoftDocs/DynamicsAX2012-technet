...
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.TransactionService.Serialization.CustomerAffiliationInfo.#ctor
dev_langs:
- CSharp
- C++
- VB
...
# CustomerAffiliationInfo Constructor
...
Dim instance As New CustomerAffiliationInfo()
```

``` csharp
public CustomerAffiliationInfo()
```

``` c++
public:
CustomerAffiliationInfo()
```

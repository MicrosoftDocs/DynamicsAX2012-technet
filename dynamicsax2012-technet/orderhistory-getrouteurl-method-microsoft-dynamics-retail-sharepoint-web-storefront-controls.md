---
title: OrderHistory.GetRouteUrl Method  (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls)
TOCTitle: GetRouteUrl Method
ms:assetid: Overload:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.OrderHistory.GetRouteUrl
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.controls.orderhistory.getrouteurl(v=AX.60)
ms:contentKeyID: 62202618
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- GetRouteUrl
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.OrderHistory.GetRouteUrl
- OrderHistory.GetRouteUrl
dev_langs:
- CSharp
- C++
- VB

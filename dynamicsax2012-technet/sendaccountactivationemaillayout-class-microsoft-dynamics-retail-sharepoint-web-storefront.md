---
title: SendAccountActivationEmailLayout Class (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront)
TOCTitle: SendAccountActivationEmailLayout Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.SendAccountActivationEmailLayout
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.sendaccountactivationemaillayout(v=AX.60)
ms:contentKeyID: 62206168
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.SendAccountActivationEmailLayout
dev_langs:
- CSharp
- C++
- VB
...
Public Class SendAccountActivationEmailLayout _
    Inherits RetailLayoutPage
'Usage
Dim instance As SendAccountActivationEmailLayout
```

``` csharp
[ComVisibleAttribute(false)]
public class SendAccountActivationEmailLayout : RetailLayoutPage
```

``` c++
[ComVisibleAttribute(false)]
public ref class SendAccountActivationEmailLayout : public RetailLayoutPage
```

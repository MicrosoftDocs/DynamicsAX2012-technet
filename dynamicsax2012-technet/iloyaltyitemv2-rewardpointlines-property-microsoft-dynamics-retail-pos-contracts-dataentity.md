...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.pos.contracts.dataentity.iloyaltyitemv2.rewardpointlines(v=AX.60)
...
Type: [System.Collections.Generic.IEnumerable](https://technet.microsoft.com/library/9eekhta0\(v=ax.60\))\<[ILoyaltyRewardPointLine](iloyaltyrewardpointline-interface-microsoft-dynamics-retail-pos-contracts-dataentity.md)\>  

---
title: IPosTransactionV1 Properties (Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity)
TOCTitle: IPosTransactionV1 Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity.IPosTransactionV1
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.dataentity.ipostransactionv1_properties(v=AX.60)
ms:contentKeyID: 47129142
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# IPosTransactionV1 Properties

The [IPosTransactionV1](ipostransactionv1-interface-microsoft-dynamics-retail-pos-contracts-dataentity.md) type exposes the following members.
...
<td>Gets the original terminal that the transaction was created on, if the transaction was transferred from another terminal.</td>
</tr>
<tr class="even">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
<td><a href="ipostransactionv1-enddatetime-property-microsoft-dynamics-retail-pos-contracts-dataentity.md">EndDateTime</a></td>
<td>Gets the finishing date and time of the transaction.</td>
</tr>
<tr class="odd">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
...
<td>Gets or sets the fiscal document ID. Available for add-in use; limited to 80 characters.</td>
</tr>
<tr class="even">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
...
<td>Gets or sets the fiscal serial ID. Available for add-in use; limited to 80 characters</td>
</tr>
<tr class="odd">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
...
<td>Gets head office currency code, for example, GBP, USD, or EUR .</td>
</tr>
<tr class="even">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
...
<td>Gets whether the last run operation was a valid payment operation.</td>
</tr>
<tr class="odd">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
<td><a href="ipostransactionv1-opendrawer-property-microsoft-dynamics-retail-pos-contracts-dataentity.md">OpenDrawer</a></td>
<td>Gets whether the drawer opened during the transaction.</td>
</tr>
<tr class="even">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
...
<td>Gets the way a statement is done for the store (staff, terminal, or total).</td>
</tr>
<tr class="even">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
...
<td>Gets the store currency code, for example, GBP, USD, or EUR.</td>
</tr>
<tr class="even">
<td><img src="images/Dn998427.pubproperty(en-us,AX.60).gif" title="Public property" alt="Public property" /></td>
...
<td>Gets the transaction ID. Note: This value is assigned quite late in the transaction process and therefore is not available from the beginning of the process.</td>
</tr>
</tbody>
</table>

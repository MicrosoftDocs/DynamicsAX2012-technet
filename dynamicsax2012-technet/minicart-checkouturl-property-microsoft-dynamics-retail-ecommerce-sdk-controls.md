---
title: MiniCart.CheckoutUrl Property  (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls)
TOCTitle: CheckoutUrl Property
ms:assetid: P:Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.MiniCart.CheckoutUrl
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.controls.minicart.checkouturl(v=AX.60)
ms:contentKeyID: 65318640
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.MiniCart.CheckoutUrl
dev_langs:
- CSharp
- C++
- VB
...
value = instance.CheckoutUrl

instance.CheckoutUrl = value
```

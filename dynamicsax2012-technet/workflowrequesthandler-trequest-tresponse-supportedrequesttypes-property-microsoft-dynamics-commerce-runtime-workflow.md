...
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Workflow.WorkflowRequestHandler`2.SupportedRequestTypes
dev_langs:
- CSharp
- C++
- VB
...
<tbody>
<tr class="odd">
<td><img src="images/Dn990315.pub(en-us,AX.60).gif" title="Dn989443.pub(en-us,AX.60).gif" alt="Dn989443.pub(en-us,AX.60).gif" /></td>

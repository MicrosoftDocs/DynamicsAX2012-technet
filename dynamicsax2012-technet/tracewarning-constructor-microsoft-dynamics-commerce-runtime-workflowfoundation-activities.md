---
title: TraceWarning Constructor  (Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities)
TOCTitle: TraceWarning Constructor
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.TraceWarning.#ctor
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.workflowfoundation.activities.tracewarning.tracewarning(v=AX.60)
ms:contentKeyID: 65317852
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.TraceWarning.#ctor
dev_langs:
- CSharp
- C++
- VB
...
Dim instance As New TraceWarning()
```

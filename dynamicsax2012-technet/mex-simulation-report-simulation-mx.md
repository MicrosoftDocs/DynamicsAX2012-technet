...
# (MEX) Simulation report (Simulation\_MX) [AX 2012]
...
<td><p>Select this check box to include all adjustment methods in the printed report.</p></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td><p><strong>Account from</strong></p></td>
<td><p>Select the starting account number of the account range to include in the report.</p></td>
</tr>
<tr class="even">
<td><p><strong>Account to</strong></p></td>
<td><p>Select the ending account number of the account range to include in the report.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\Simulation_MX</p></td>
</tr>
<tr class="odd">
<td><p>Menu item of the report</p></td>
<td><p>InfAdjSimulation_MX</p></td>
</tr>
<tr class="even">
<td><p>Navigation to the report</p></td>
<td><p>Click <strong>General ledger</strong> &gt; <strong>Periodic</strong> &gt; <strong>Inflation adjustment B-10</strong>. Select an inflation adjustment record, and then click <strong>Simulation</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - CapitalAdjReportTmp\_MX table
    

    > [!NOTE]
    > <P>To find out where the data in the temp table comes from, view the cross-references for the InfAdjSimulationDP_MX.processReport class.</P>

...
4.  Click **Functions** \> **Settle open transactions** to open the **Settle open transactions** form. Then select the open customer transactions for settlement. For more information, see [Open customer transactions (form)](https://technet.microsoft.com/library/aa586034\(v=ax.60\)).

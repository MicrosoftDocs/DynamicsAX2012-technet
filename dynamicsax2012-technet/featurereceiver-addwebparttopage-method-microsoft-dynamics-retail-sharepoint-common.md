...
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Common.FeatureReceiver.AddWebPartToPage
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public Shared Sub AddWebPartToPage ( _
    web As SPWeb, _
...
FeatureReceiver.AddWebPartToPage(web, webPart, _
    zoneId, page)
```

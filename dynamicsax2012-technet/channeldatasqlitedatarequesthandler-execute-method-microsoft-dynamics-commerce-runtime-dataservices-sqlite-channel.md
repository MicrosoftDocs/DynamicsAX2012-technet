...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.sqlite.channel.channeldatasqlitedatarequesthandler.execute(v=AX.60)

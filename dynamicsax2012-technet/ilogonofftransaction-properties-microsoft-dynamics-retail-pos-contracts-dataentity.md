---
title: ILogOnOffTransaction Properties (Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity)
TOCTitle: ILogOnOffTransaction Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity.ILogOnOffTransaction
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.pos.contracts.dataentity.ilogonofftransaction_properties(v=AX.60)
ms:contentKeyID: 49826282
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ILogOnOffTransaction Properties

The [ILogOnOffTransaction](ilogonofftransaction-interface-microsoft-dynamics-retail-pos-contracts-dataentity.md) type exposes the following members.
...
[ILogOnOffTransaction Interface](ilogonofftransaction-interface-microsoft-dynamics-retail-pos-contracts-dataentity.md)

---
title: GetItemDimensionsRequestHandler.Process Method  (Microsoft.Dynamics.Commerce.Runtime.Workflow)
TOCTitle: Process Method
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.Workflow.GetItemDimensionsRequestHandler.Process
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.workflow.getitemdimensionsrequesthandler.process(v=AX.60)
ms:contentKeyID: 65318082
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Process
- GetItemDimensionsRequestHandler.Process
- Microsoft.Dynamics.Commerce.Runtime.Workflow.GetItemDimensionsRequestHandler.Process
dev_langs:
- CSharp
- C++
- VB
...
<tbody>
<tr class="odd">
<td><img src="images/Dn990315.pub(en-us,AX.60).gif" title="Dn988529.pub(en-us,AX.60).gif" alt="Dn988529.pub(en-us,AX.60).gif" /></td>

---
title: ChannelMapper Methods (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Mappers)
TOCTitle: ChannelMapper Methods
ms:assetid: Methods.T:Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Mappers.ChannelMapper
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.core.mappers.channelmapper_methods(v=AX.60)
ms:contentKeyID: 65316544
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ChannelMapper Methods

The [ChannelMapper](channelmapper-class-microsoft-dynamics-retail-ecommerce-sdk-core-mappers.md) type exposes the following members.
...
[ChannelMapper Class](channelmapper-class-microsoft-dynamics-retail-ecommerce-sdk-core-mappers.md)

...
# WrongEndpointException Class


[!INCLUDE[archive-banner](includes/archive-banner.md)]

The wrong endpoint exception.
...
Public Class WrongEndpointException _
    Inherits Exception
'Usage
...
public class WrongEndpointException : Exception
```

``` c++
[SerializableAttribute]
public ref class WrongEndpointException : public Exception
```

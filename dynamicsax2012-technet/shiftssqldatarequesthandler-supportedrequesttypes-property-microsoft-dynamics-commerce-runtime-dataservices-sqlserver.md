...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.sqlserver.shiftssqldatarequesthandler.supportedrequesttypes(v=AX.60)

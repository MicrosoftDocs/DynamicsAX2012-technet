---
title: TopNavigationMenu Class (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls)
TOCTitle: TopNavigationMenu Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.Controls.TopNavigationMenu
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.controls.topnavigationmenu(v=AX.60)
ms:contentKeyID: 62202567
ms.date: 05/18/2015
...
``` vb
'Declaration
Public Class TopNavigationMenu _
    Inherits BaseUserControl
'Usage
Dim instance As TopNavigationMenu
```

``` csharp
public class TopNavigationMenu : BaseUserControl
```

``` c++
public ref class TopNavigationMenu : public BaseUserControl
```

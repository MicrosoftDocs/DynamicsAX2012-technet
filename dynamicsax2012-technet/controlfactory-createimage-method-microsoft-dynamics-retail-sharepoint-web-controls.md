...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.controls.controlfactory.createimage(v=AX.60)
...
Type: [System.Web.UI.HtmlControls.HtmlImage](https://technet.microsoft.com/en-us/library/kd9cwet3\(v=ax.60\))  

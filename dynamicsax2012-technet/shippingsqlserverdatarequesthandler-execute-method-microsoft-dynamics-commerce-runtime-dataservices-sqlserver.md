...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.sqlserver.shippingsqlserverdatarequesthandler.execute(v=AX.60)

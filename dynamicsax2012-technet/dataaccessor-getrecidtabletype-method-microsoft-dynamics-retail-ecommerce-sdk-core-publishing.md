...
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Publishing.DataAccessor.GetRecIdTableType
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public Shared Function GetRecIdTableType As DataTable
'Usage
Dim returnValue As DataTable

returnValue = DataAccessor.GetRecIdTableType()
```
...
``` c++
public:
static DataTable^ GetRecIdTableType()
```

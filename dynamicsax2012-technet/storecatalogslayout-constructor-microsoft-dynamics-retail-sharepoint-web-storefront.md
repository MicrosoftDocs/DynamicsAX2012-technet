...
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.StoreCatalogsLayout.#ctor
dev_langs:
- CSharp
- C++
- VB
...
# StoreCatalogsLayout Constructor
...
Dim instance As New StoreCatalogsLayout()
```

``` csharp
public StoreCatalogsLayout()
```

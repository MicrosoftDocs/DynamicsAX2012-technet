...
# (CHN) Cash daily (report) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2_

Generate and print a report that displays the daily total debit and credit amounts for the cash ledger accounts. The report also displays the number of vouchers that are processed each day.
...
<td><p>Select the date for which to generate the daily cash report.</p></td>
</tr>
<tr class="even">

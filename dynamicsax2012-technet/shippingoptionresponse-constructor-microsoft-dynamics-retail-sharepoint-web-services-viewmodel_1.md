...
ms:assetid: M:Microsoft.Dynamics.Retail.SharePoint.Web.Services.ViewModel.ShippingOptionResponse.#ctor
...
Dim instance As New ShippingOptionResponse()
```

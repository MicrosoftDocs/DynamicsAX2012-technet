---
title: HtmlComplexTable Class (Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls)
TOCTitle: HtmlComplexTable Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlComplexTable
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sharepoint.web.controls.htmlcontrols.htmlcomplextable(v=AX.60)
ms:contentKeyID: 62204218
author: Khairunj
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Controls.HtmlControls.HtmlComplexTable
dev_langs:
- CSharp
- C++
- VB
...
Public Class HtmlComplexTable _
...
public class HtmlComplexTable : HtmlContainerControl
```

``` c++
[ComVisibleAttribute(false)]
public ref class HtmlComplexTable : public HtmlContainerControl
```

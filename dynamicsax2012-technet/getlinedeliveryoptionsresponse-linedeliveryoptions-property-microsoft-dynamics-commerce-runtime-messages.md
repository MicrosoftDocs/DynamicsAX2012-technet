...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.getlinedeliveryoptionsresponse.linedeliveryoptions(v=AX.60)

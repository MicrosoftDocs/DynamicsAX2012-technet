...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ677657(v=AX.60)
...
1.  Click **General ledger** \> **Setup** \> **Posting** \> **Accounts for automatic transactions**.
    ...
    > [!NOTE]
    > <P>For more information, see <A href="https://technet.microsoft.com/en-us/library/aa548973(v=ax.60)">Accounts for automatic transactions (form)</A>.</P>

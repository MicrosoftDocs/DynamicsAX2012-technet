...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.sqlserver.shippingdatarequesthandler.supportedrequesttypes(v=AX.60)

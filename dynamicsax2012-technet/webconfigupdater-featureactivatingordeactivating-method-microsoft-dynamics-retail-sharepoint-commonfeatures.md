...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.commonfeatures.webconfigupdater.featureactivatingordeactivating(v=AX.60)

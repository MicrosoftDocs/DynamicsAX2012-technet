...
# (RUS) Set up the numbering sequence for the tax register journal [AX 2012]
...
3.  In the **Number sequence code** field, select the number sequence code for **Tax register journal number**.

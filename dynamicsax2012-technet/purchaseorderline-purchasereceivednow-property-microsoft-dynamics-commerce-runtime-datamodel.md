---
title: PurchaseOrderLine.PurchaseReceivedNow Property  (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: PurchaseReceivedNow Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataModel.PurchaseOrderLine.PurchaseReceivedNow
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.purchaseorderline.purchasereceivednow(v=AX.60)
ms:contentKeyID: 62210905
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.PurchaseOrderLine.PurchaseReceivedNow
dev_langs:
- CSharp
- C++
- VB

---
title: StoreProductAvailability Class (Microsoft.Dynamics.Retail.SharePoint.Web.Controls)
TOCTitle: StoreProductAvailability Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.Controls.StoreProductAvailability
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sharepoint.web.controls.storeproductavailability(v=AX.60)
ms:contentKeyID: 62203027
author: Khairunj
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.Controls.StoreProductAvailability
dev_langs:
- CSharp
- C++
- VB
...
public class StoreProductAvailability : RetailWebControl
```

``` c++
[ComVisibleAttribute(false)]
public ref class StoreProductAvailability : public RetailWebControl
```

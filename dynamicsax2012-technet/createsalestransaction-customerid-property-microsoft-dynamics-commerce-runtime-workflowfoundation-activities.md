---
title: CreateSalesTransaction.CustomerId Property  (Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities)
TOCTitle: CustomerId Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.CreateSalesTransaction.CustomerId
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.workflowfoundation.activities.createsalestransaction.customerid(v=AX.60)
ms:contentKeyID: 65322846
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.WorkflowFoundation.Activities.CreateSalesTransaction.CustomerId
dev_langs:
- CSharp
- C++
- VB

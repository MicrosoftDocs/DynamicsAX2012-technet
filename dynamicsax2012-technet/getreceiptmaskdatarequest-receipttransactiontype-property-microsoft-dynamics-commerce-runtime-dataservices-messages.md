...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.messages.getreceiptmaskdatarequest.receipttransactiontype(v=AX.60)

...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Messages.GetProductDeliveryOptionsResponse.#ctor
...
Dim instance As New GetProductDeliveryOptionsResponse()
```

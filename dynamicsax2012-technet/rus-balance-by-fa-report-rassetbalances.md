...
# (RUS) Balance by FA report (RAssetBalances) [AX 2012]
...
<td><p>RAssetBalances</p></td>
</tr>
<tr class="even">
<td><p>Location of report in the AOT</p></td>
<td><p>SSRS Reports\Reports\RAssetBalances</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Fixed assets (Russia)</strong> &gt; <strong>Reports</strong> &gt; <strong>Balance by FA</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - RAssetBalancesTMP table
    ...
    > [!NOTE]
    > <P>To find out where the data in the temp table comes from, view the cross-references for the RAssetBalancesDP.processReport class.</P>

...
f1_keywords:
- SSRS_Reports.Reports.CustInvoice
---

# Customer invoice transactions report (CustInvoice) [AX 2012]
...
<td><p>Select the start of the date range for the posted customer invoice transactions to include on the report.</p></td>
</tr>
<tr class="odd">
<td><p><strong>To date</strong></p></td>
<td><p>Select the end of the date range for the posted customer invoice transactions to include on the report.</p></td>
</tr>
<tr class="even">
<td><p><strong>Invoice type</strong></p></td>
<td><p>Select the type of customer invoice transactions to include on the report. You can select invoice transactions that are open, paid, or both open and paid.</p></td>
</tr>
<tr class="odd">
<td><p><strong>Invoice account</strong></p></td>
<td><p>The selected customer invoice account or accounts that will be included on the report. Click <strong>Select</strong> to select invoice accounts.</p></td>
</tr>
<tr class="even">
<td><p><strong>Customer account</strong></p></td>
<td><p>The selected customer account or accounts whose transactions will be included on the report. Click <strong>Select</strong> to select customer accounts.</p></td>
</tr>
<tr class="odd">
<td><p><strong>Date</strong></p></td>
<td><p>The date of the selected customer invoice transaction or transactions that will be included on the report. Click <strong>Select</strong> to select a date.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\CustInvoice</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Accounts receivable</strong> &gt; <strong>Reports</strong> &gt; <strong>Transactions</strong> &gt; <strong>Invoice</strong> &gt; <strong>Customer invoice transactions</strong>.</p></td>
</tr>
</tbody>
</table>
...
> [!NOTE]
> <P>To determine where the data in the temp table comes from, view the cross-references for the CustInvoiceDP.processReport class.</P>

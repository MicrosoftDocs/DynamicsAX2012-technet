---
title: PricingDatabaseAccessor.GetMultipleBuyDiscountLinesByOfferIds Method  (Microsoft.Dynamics.Commerce.Runtime.Data)
TOCTitle: GetMultipleBuyDiscountLinesByOfferIds Method
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Data.PricingDatabaseAccessor.GetMultipleBuyDiscountLinesByOfferIds(System.Collections.Generic.IEnumerable{System.String})
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.pricingdatabaseaccessor.getmultiplebuydiscountlinesbyofferids(v=AX.60)
ms:contentKeyID: 62211411
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Data.PricingDatabaseAccessor.GetMultipleBuyDiscountLinesByOfferIds
dev_langs:
- CSharp
- C++
- VB

...
For more information about new or changed Help features in Microsoft Dynamics AX 2012, see [What's new: Help system](what-s-new-help-system.md) in the “New, Changed, and Deprecated Features for AX 2012” section on TechNet.

[Planning and architecture of the Help system](planning-and-architecture-of-the-help-system.md)

[Deployment of the Help server](deployment-of-the-help-server.md)

[Help server operations](help-server-operations.md)

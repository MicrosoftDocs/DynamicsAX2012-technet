---
title: ShoppingCartController.GetActiveShoppingCart Method  (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Controllers)
TOCTitle: GetActiveShoppingCart Method
ms:assetid: M:Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Controllers.ShoppingCartController.GetActiveShoppingCart(System.String,Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Models.ShoppingCartDataLevel,Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.IProductValidator,Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.ISearchEngine)
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.core.controllers.shoppingcartcontroller.getactiveshoppingcart(v=AX.60)
ms:contentKeyID: 65316332
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Controllers.ShoppingCartController.GetActiveShoppingCart
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Public Overridable Function GetActiveShoppingCart ( _
...
returnValue = instance.GetActiveShoppingCart(customerId, _
    dataLevel, productValidator, searchEngine)
```

``` csharp
public virtual ShoppingCart GetActiveShoppingCart(
    string customerId,
...
``` c++
public:
virtual ShoppingCart^ GetActiveShoppingCart(
    String^ customerId, 
    ShoppingCartDataLevel dataLevel, 
    IProductValidator^ productValidator, 
    ISearchEngine^ searchEngine

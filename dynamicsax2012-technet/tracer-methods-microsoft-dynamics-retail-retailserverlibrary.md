---
title: Tracer Methods (Microsoft.Dynamics.Retail.RetailServerLibrary)
TOCTitle: Tracer Methods
ms:assetid: Methods.T:Microsoft.Dynamics.Retail.RetailServerLibrary.Tracer
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.retailserverlibrary.tracer_methods(v=AX.60)
ms:contentKeyID: 62203361
ms.date: 04/21/2014
...
The [Tracer](tracer-class-microsoft-dynamics-retail-retailserverlibrary.md) type exposes the following members.
...
<tr class="odd">
<td><img src="images/Dn987397.pubmethod(en-us,AX.60).gif" title="Public method" alt="Public method" /></td>
<td><a href="tracer-trace-method-microsoft-dynamics-retail-retailserverlibrary.md">Trace</a></td>
<td>The trace method.</td>
</tr>
</tbody>
</table>

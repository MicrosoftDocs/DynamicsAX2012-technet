---
title: MiniCart.GetRouteUrl Method  (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls)
TOCTitle: GetRouteUrl Method
ms:assetid: Overload:Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.MiniCart.GetRouteUrl
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.controls.minicart.getrouteurl(v=AX.60)
ms:contentKeyID: 65318567
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- GetRouteUrl
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.MiniCart.GetRouteUrl
- MiniCart.GetRouteUrl
dev_langs:
- CSharp
- C++
- VB

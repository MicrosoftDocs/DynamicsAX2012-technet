---
title: Utilities.GetDefaultProductImageData Method  (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core)
TOCTitle: GetDefaultProductImageData Method
ms:assetid: M:Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Utilities.GetDefaultProductImageData
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.core.utilities.getdefaultproductimagedata(v=AX.60)
ms:contentKeyID: 65317808
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Core.Utilities.GetDefaultProductImageData
dev_langs:
- CSharp
- C++
- VB

---
title: MiniCart.OnPreRender Method  (Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls)
TOCTitle: OnPreRender Method
ms:assetid: M:Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.MiniCart.OnPreRender(System.EventArgs)
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.controls.minicart.onprerender(v=AX.60)
ms:contentKeyID: 65316709
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.Ecommerce.Sdk.Controls.MiniCart.OnPreRender
dev_langs:
- CSharp
- C++
- VB

...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.ecommerce.sdk.services.kitcomponentvariantresponse.kitcomponentvariants(v=AX.60)

---
title: GetAddressRequestHandler.Context Property  (Microsoft.Dynamics.Commerce.Runtime.Workflow)
TOCTitle: Context Property
ms:assetid: Overload:Microsoft.Dynamics.Commerce.Runtime.Workflow.GetAddressRequestHandler.Context
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.workflow.getaddressrequesthandler.context(v=AX.60)
ms:contentKeyID: 65318027
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Context
- GetAddressRequestHandler.Context
- Microsoft.Dynamics.Commerce.Runtime.Workflow.GetAddressRequestHandler.Context
dev_langs:
- CSharp
- C++
- VB
...
<tbody>
<tr class="odd">
<td><img src="images/Dn990315.pub(en-us,AX.60).gif" title="Dn988474.pub(en-us,AX.60).gif" alt="Dn988474.pub(en-us,AX.60).gif" /></td>

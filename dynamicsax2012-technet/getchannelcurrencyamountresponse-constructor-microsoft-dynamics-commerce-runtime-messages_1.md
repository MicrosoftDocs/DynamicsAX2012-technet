...
ms:assetid: M:Microsoft.Dynamics.Commerce.Runtime.Messages.GetChannelCurrencyAmountResponse.#ctor
...
Dim instance As New GetChannelCurrencyAmountResponse()
```

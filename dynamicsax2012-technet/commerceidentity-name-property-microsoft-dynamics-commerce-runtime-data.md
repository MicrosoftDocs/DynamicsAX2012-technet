...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.commerceidentity.name(v=AX.60)
...
[IIdentity.Name](https://technet.microsoft.com/en-us/library/9cba0wt3\(v=ax.60\))  

---
title: MakePaymentResponse Class (Microsoft.Dynamics.Commerce.Runtime.Sdk.HardwareStation)
TOCTitle: MakePaymentResponse Class
ms:assetid: T:Microsoft.Dynamics.Commerce.Runtime.Sdk.HardwareStation.MakePaymentResponse
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.sdk.hardwarestation.makepaymentresponse(v=AX.60)
ms:contentKeyID: 65315554
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.Sdk.HardwareStation.MakePaymentResponse
dev_langs:
- CSharp
- C++
- VB
...
Response for Make Payment operation.
...
Public Class MakePaymentResponse _
    Inherits Response
'Usage
...
``` c++
[DataContractAttribute]
public ref class MakePaymentResponse : public Response
```

---
title: AttributeProductListing Methods (Microsoft.Dynamics.Retail.Ecommerce.SP.Publishing.Connector.CatalogManagement)
TOCTitle: AttributeProductListing Methods
ms:assetid: Methods.T:Microsoft.Dynamics.Retail.Ecommerce.SP.Publishing.Connector.CatalogManagement.AttributeProductListing
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sp.publishing.connector.catalogmanagement.attributeproductlisting_methods(v=AX.60)
ms:contentKeyID: 65317872
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# AttributeProductListing Methods

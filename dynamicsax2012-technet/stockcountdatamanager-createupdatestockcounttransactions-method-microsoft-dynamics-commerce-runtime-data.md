...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.data.stockcountdatamanager.createupdatestockcounttransactions(v=AX.60)

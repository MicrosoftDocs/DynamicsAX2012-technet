...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.commerce.runtime.services.messages.getorderdeliveryoptionsserviceresponse.deliveryoptions(v=AX.60)

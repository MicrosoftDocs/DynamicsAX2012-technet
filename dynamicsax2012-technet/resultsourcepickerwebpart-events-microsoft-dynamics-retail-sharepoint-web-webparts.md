---
title: ResultSourcePickerWebPart Events (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts)
TOCTitle: ResultSourcePickerWebPart Events
ms:assetid: Events.T:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.ResultSourcePickerWebPart
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sharepoint.web.webparts.resultsourcepickerwebpart_events(v=AX.60)
ms:contentKeyID: 62206973
author: Khairunj
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ResultSourcePickerWebPart Events
...
<td>AfterSerializeToClient</td>
<td>(Inherited from ScriptWebPart.)</td>
</tr>
<tr class="even">
<td><img src="images/Dn998623.pubevent(en-us,AX.60).gif" title="Public event" alt="Public event" /></td>
<td>BeforeSerializeToClient</td>
<td>(Inherited from ScriptWebPart.)</td>
</tr>
<tr class="odd">
<td><img src="images/Dn998623.pubevent(en-us,AX.60).gif" title="Public event" alt="Public event" /></td>

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.common.utilities.getkitvariantproductinfo(v=AX.60)
...
#### Parameters
  ...
  - kitMasterProductId  
    Type: [System.SByte](https://technet.microsoft.com/en-us/library/f71b253d\(v=ax.60\))  

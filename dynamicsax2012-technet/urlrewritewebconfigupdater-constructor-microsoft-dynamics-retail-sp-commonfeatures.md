...
ms:mtpsurl: https://technet.microsoft.com/library/microsoft.dynamics.retail.sp.commonfeatures.urlrewritewebconfigupdater.urlrewritewebconfigupdater(v=AX.60)

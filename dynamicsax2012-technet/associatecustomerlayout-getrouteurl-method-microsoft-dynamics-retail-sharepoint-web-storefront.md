---
title: AssociateCustomerLayout.GetRouteUrl Method  (Microsoft.Dynamics.Retail.SharePoint.Web.Storefront)
TOCTitle: GetRouteUrl Method
ms:assetid: Overload:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.AssociateCustomerLayout.GetRouteUrl
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.storefront.associatecustomerlayout.getrouteurl(v=AX.60)
ms:contentKeyID: 62202837
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- GetRouteUrl
- AssociateCustomerLayout.GetRouteUrl
- Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.AssociateCustomerLayout.GetRouteUrl
dev_langs:
- CSharp
- C++
- VB

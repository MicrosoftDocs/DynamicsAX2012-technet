...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.icollectionextensions_methods(v=AX.60)
...
<td>Adds the elements of the specified collection to the end of the <a href="https://technet.microsoft.com/en-us/library/92t2ye13(v=ax.60)">ICollection&lt;T&gt;</a>.</td>
</tr>
</tbody>
</table>

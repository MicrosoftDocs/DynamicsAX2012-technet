---
title: SecurityException Constructor (String) (Microsoft.Dynamics.Commerce.Runtime)
TOCTitle: SecurityException Constructor (String)
...
Dim instance As New SecurityException(errorResourceId)
```

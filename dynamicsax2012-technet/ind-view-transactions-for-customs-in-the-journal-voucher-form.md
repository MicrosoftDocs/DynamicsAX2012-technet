...
6.  Click **Functions** \> **Invoice pool excl. posting** to open the **Invoice pool excl. posting** form.
    ...
    > [!NOTE]
    > <P>You can view the automatically update the sales tax group, the item sales tax group, the customs tariff codes, and the customs tariff direction from the <STRONG>Invoice pool excl. posting</STRONG> form.</P>

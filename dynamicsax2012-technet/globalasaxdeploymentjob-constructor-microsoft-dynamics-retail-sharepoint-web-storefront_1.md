...
ms:assetid: M:Microsoft.Dynamics.Retail.SharePoint.Web.Storefront.GlobalASAXDeploymentJob.#ctor
...
Initializes a new instance of the GlobalAsaxDeploymentJob class.
...
Dim instance As New GlobalASAXDeploymentJob()
```

...
# (CAN, USA) Vendor detailed due day list report (VendDueReportDetail\_NA) [AX 2012]
...
<td><p>Enter the date to use for calculating the number of days that each transaction is overdue. The default date is the system date.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\VendDueReportDetail_NA</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Accounts payable</strong> &gt; <strong>Reports</strong> &gt; <strong>Status</strong> &gt; <strong>Vendor detailed due day list</strong>.</p></td>
</tr>
</tbody>
</table>

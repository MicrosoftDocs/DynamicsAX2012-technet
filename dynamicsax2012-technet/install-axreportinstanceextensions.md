...
## Syntax
    ...
    Install-AXReportInstanceExtensions [-Credential <PSCredential> ] [-ReportServerInstanceName <String> ] [-ServicesAOSName <String> ] [-ServicesAOSWSDLPort <Int32> ] [-ServicesFilePath <String> ] [ <CommonParameters>]

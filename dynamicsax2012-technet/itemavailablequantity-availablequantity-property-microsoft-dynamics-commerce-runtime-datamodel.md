---
title: ItemAvailableQuantity.AvailableQuantity Property  (Microsoft.Dynamics.Commerce.Runtime.DataModel)
TOCTitle: AvailableQuantity Property
ms:assetid: P:Microsoft.Dynamics.Commerce.Runtime.DataModel.ItemAvailableQuantity.AvailableQuantity
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.datamodel.itemavailablequantity.availablequantity(v=AX.60)
ms:contentKeyID: 49836017
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Commerce.Runtime.DataModel.ItemAvailableQuantity.AvailableQuantity
dev_langs:
- CSharp
- C++
- VB

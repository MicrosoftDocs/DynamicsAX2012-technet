---
title: GetEmployeeDataRequestBase Properties (Microsoft.Dynamics.Commerce.Runtime.DataServices.Messages)
TOCTitle: GetEmployeeDataRequestBase Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.DataServices.Messages.GetEmployeeDataRequestBase
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.dataservices.messages.getemployeedatarequestbase_properties(v=AX.60)
ms:contentKeyID: 65317932
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetEmployeeDataRequestBase Properties

The [GetEmployeeDataRequestBase](getemployeedatarequestbase-class-microsoft-dynamics-commerce-runtime-dataservices-messages.md) type exposes the following members.

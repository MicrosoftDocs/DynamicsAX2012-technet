...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.services.orderservice.getcommittedsalesorderbyconfirmationid(v=AX.60)

...
# Project profit and loss (2 periods) report (ProjProfitLossProj2Prd) [AX 2012]


_**Applies To:** Microsoft Dynamics AX 2012 R3, Microsoft Dynamics AX 2012 R2, Microsoft Dynamics AX 2012 Feature Pack, Microsoft Dynamics AX 2012_

Use this report to analyze the profit or loss by project for two specified date ranges.
...
<td><p>Click <strong>Select</strong>. In the <strong>Project profit and loss (2 periods)</strong> form, select a project to include on the report. To add more than one project, click <strong>Add</strong>.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\ProjProfitLossProj2Prd</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Project management and accounting</strong> &gt; <strong>Reports</strong> &gt; <strong>Project statements</strong> &gt; <strong>Profit and loss</strong> &gt; <strong>Profit and loss (2 periods)</strong> &gt; <strong>Project profit and loss (2 periods)</strong>.</p></td>
</tr>
</tbody>
</table>
...
The data on this report comes from the following sources:
  ...
  - ProjListProjProfitLossProj2PrdDP.processReport
...
> [!NOTE]
> <P>To determine where the data in the temp table comes from, view the cross-references for the ProjListProjProfitLossProj2PrdDP.processReport class.</P>

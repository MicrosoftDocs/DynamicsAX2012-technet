---
title: GetCurrentChannelRequest Properties (Microsoft.Dynamics.Commerce.Runtime.Messages)
TOCTitle: GetCurrentChannelRequest Properties
ms:assetid: Properties.T:Microsoft.Dynamics.Commerce.Runtime.Messages.GetCurrentChannelRequest
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.commerce.runtime.messages.getcurrentchannelrequest_properties(v=AX.60)
ms:contentKeyID: 49831404
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# GetCurrentChannelRequest Properties

The [GetCurrentChannelRequest](getcurrentchannelrequest-class-microsoft-dynamics-commerce-runtime-messages.md) type exposes the following members.

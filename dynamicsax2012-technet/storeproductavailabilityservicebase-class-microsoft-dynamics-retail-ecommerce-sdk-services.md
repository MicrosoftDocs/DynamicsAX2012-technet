...
# StoreProductAvailabilityServiceBase Class
...
Public MustInherit Class StoreProductAvailabilityServiceBase _
    Inherits ServiceBase(Of StoreProductAvailabilityController) _
...
public abstract class StoreProductAvailabilityServiceBase : ServiceBase<StoreProductAvailabilityController>, 
    IStoreProductAvailabilityService
```

``` c++
[ComVisibleAttribute(false)]
public ref class StoreProductAvailabilityServiceBase abstract : public ServiceBase<StoreProductAvailabilityController^>, 
    IStoreProductAvailabilityService
```

...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.ecommerce.sdk.controls.mvchelperextension.shoppingcartcontrolheader(v=AX.60)

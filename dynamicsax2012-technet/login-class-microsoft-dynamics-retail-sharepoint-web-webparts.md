---
title: Login Class (Microsoft.Dynamics.Retail.SharePoint.Web.WebParts)
TOCTitle: Login Class
ms:assetid: T:Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.Login
ms:mtpsurl: https://technet.microsoft.com/en-us/library/microsoft.dynamics.retail.sharepoint.web.webparts.login(v=AX.60)
ms:contentKeyID: 62204437
ms.date: 05/18/2015
mtps_version: v=AX.60
f1_keywords:
- Microsoft.Dynamics.Retail.SharePoint.Web.WebParts.Login
dev_langs:
- CSharp
- C++
- VB
...
``` c++
[ComVisibleAttribute(false)]
public ref class Login : public WebPart
```

...
# Bank statement report (BankAccountStatement) [AX 2012]
...
<td><p>Select the first date in the period for which to view transactions.</p></td>
</tr>
<tr class="even">
<td><p><strong>Closing</strong></p></td>
<td><p>Select the last date in the period for which to view transactions.</p></td>
</tr>
</tbody>
</table>
...
<td><p>SSRS Reports\Reports\BankAccountStatement</p></td>
</tr>
<tr class="odd">
...
<td><p>Click <strong>Cash and bank management</strong> &gt; <strong>Reports</strong> &gt; <strong>Transactions</strong> &gt; <strong>Bank statement</strong>.</p></td>
</tr>
</tbody>
</table>
...
> [!NOTE]
> <P>To determine where the data in the temp tables comes from, view the cross-references for the BankAccountStatementDP.processReport class.</P>

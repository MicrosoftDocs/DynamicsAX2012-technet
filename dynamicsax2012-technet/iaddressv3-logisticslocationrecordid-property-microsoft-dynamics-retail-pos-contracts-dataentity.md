...
f1_keywords:
- Microsoft.Dynamics.Retail.Pos.Contracts.DataEntity.IAddressV3.LogisticsLocationRecordId
dev_langs:
- CSharp
- C++
- VB
...
``` vb
'Declaration
Property LogisticsLocationRecordId As Long
    Get
    Set
'Usage
...
``` csharp
long LogisticsLocationRecordId { get; set; }
```
